...
- [ ] T005 Introduce deterministic guest share URL helper (Domain) in `src/domain/collaboration/whiteboard/utils/buildGuestShareUrl.ts`

**Checkpoint**: GraphQL schema, generated types, and shared helpers support guest access flows.
