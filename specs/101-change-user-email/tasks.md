...
- [x] T006 Run `pnpm codegen` against a backend with server spec 097 deployed (`localhost:3000/graphql`), then commit the regenerated `src/core/apollo/generated/graphql-schema.ts`, `apollo-hooks.ts`, `apollo-helpers.ts` (research.md D3; contracts/graphql.md §6)
