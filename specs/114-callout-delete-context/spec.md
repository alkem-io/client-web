...
- **FR-005**: When a callout has named links available at deletion time (a framing body link and framing references), the dialog MUST identify them by link title, falling back to the URL. Link contributions are listed by title among the contributions (FR-002), not in this list.
