...
- [X] T017 [P] Run `pnpm vitest run` from the repo root. Confirm the existing test suite (≈57 files / 595 tests) passes with no regressions; no new test files are expected.
