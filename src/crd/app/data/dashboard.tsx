import { FileText, Megaphone, MessageSquare, Presentation, StickyNote, User } from 'lucide-react';
...
export const MOCK_SPACE_ACTIVITIES = [
  {
    ...
    avatarInitials: 'SC',
    userName: 'Sarah Chen',
    activityIcon: <Megaphone aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New callout',
    title: 'Cross-industry collaboration challenge',
    titleHref: '/space/innovation-lab/callout/cross-industry',
    contextName: 'Innovation Lab',
  ...
  },
  {
    ...
    avatarInitials: 'MR',
    userName: 'Mike Ross',
    activityIcon: <MessageSquare aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New comment',
    title: 'Great work on the latest iteration — the spacing feels much tighter now.',
    titleHref: '/space/design-workshop/post/design-review',
    contextName: 'Design Review',
  ...
  },
  {
    ...
    avatarInitials: 'AS',
    userName: 'Anna Smith',
    activityIcon: <FileText aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New post',
    title: 'Q4 campaign performance wrap-up',
    titleHref: '/space/marketing/post/q4-wrap-up',
    contextName: 'Marketing Strategy',
    timestamp: 'Yesterday',
  },
  {
    id: 'sa-4',
    ...
    avatarInitials: 'DK',
    userName: 'David Kim',
    activityIcon: <Presentation aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New whiteboard',
    title: 'Product Roadmap Q1',
    titleHref: '/space/product/whiteboard/roadmap-q1',
    contextName: 'Product Roadmap',
    timestamp: 'Yesterday',
  },
  {
    id: 'sa-5',
    ...
    activityIcon: <User aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New member',
    title: 'Elena Rodriguez joined',
    titleHref: '/user/elena-rodriguez',
    contextName: 'Community Hub',
  ...
  },
  {
    ...
    activityIcon: <StickyNote aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New memo',
    title: 'Retrospective notes — Q3 goals',
    contextName: 'Q3 Goals',
  ...
  },
  {
    ...
    titleHref: '/space/innovation-lab/callout/weekly-sync',
    contextName: 'Innovation Lab',
    timestamp: '3 days ago',
  },
];
...
export const MOCK_PERSONAL_ACTIVITIES = [
  {
    ...
    titleHref: '/space/project-alpha/callout/kickoff',
  ...
  },
  {
    ...
    activityIconLabel: 'New member',
    title: 'You joined',
    titleHref: '/space/team-sync',
    contextName: 'Team Sync',
    timestamp: '2 days ago',
  },
  {
    id: 'pa-3',
    ...
    activityIcon: <MessageSquare aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New comment',
    title: "I like where this is going — let's sync Thursday to finalise.",
    titleHref: '/space/design-workshop/post/design-review',
    contextName: 'Design Review',
  ...
  },
  {
    ...
    activityIcon: <FileText aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New post',
    title: 'October growth summary',
    titleHref: '/space/analytics/post/oct-growth',
    contextName: 'Analytics Dashboard',
  ...
  },
  {
    ...
    activityIcon: <StickyNote aria-hidden="true" className={ICON_CLASS} />,
    activityIconLabel: 'New memo',
    title: '1:1 with manager — career planning',
    contextName: 'My Workspace',
    timestamp: '1 week ago',
  },
];
