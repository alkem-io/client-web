...
const AVATARS = {
  ...
  elena: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
...
export const MOCK_POSTS: PostCardData[] = [
  {
    ...
    snippet: 'We are officially launching the strategy phase for the 2030 renewable transition. Our goal is to outline a clear path for municipalities to reach 100% renewable energy. Please review the initial policy draft.',
...
const memberNames = [
  'Elena Martinez', 'Sarah Chen', 'Maya Ross', 'David Kim', 'Robert Fox',
...
export const MOCK_MEMBERS: MemberCardData[] = memberNames.map((name, i) => ({
  ...
  tagline: ['Community Host', 'Sustainability Researcher', 'Energy Policy Expert', 'Urban Planner', 'Data Scientist'][i % 5],
  tags: [['sustainability', 'policy'], ['energy', 'research'], ['urban', 'planning'], ['data', 'analytics'], ['community']][i % 5],
  href: `/user/${name.toLowerCase().replace(/\s+/g, '-')}`,
}));

export const MOCK_ORGANIZATIONS: MemberCardData[] = [
  { id: 'o1', name: 'Green Future Labs', avatarUrl: undefined, type: 'organization', location: 'Amsterdam, NL', tagline: 'Research Institute for Sustainable Innovation', tags: ['research', 'sustainability'], href: '/org/green-future-labs' },
  { id: 'o2', name: 'City of Amsterdam', avatarUrl: undefined, type: 'organization', location: 'Amsterdam, NL', tagline: 'Municipality', tags: ['government', 'urban'], href: '/org/city-of-amsterdam' },
  { id: 'o3', name: 'Utrecht University', avatarUrl: undefined, type: 'organization', location: 'Utrecht, NL', tagline: 'Academic Partner', tags: ['academic', 'research'], href: '/org/utrecht-university' },
  { id: 'o4', name: 'Sustainable Cities Fund', avatarUrl: undefined, type: 'organization', location: 'Brussels, BE', tagline: 'NGO', tags: ['funding', 'sustainability'], href: '/org/sustainable-cities-fund' },
];
...
export const MOCK_SUBSPACES: SubspaceListCardData[] = [
  { id: 'sub-1', name: 'Renewable Energy Transition', tagline: 'Strategy and policy for 100% renewable energy by 2030', bannerUrl: SUBSPACE_BANNERS[0], tags: ['energy', 'policy', 'strategy'], isPrivate: false, isMember: true, isPinned: false, leads: [{ name: 'Sarah Chen', avatarUrl: AVATARS.sarah }], href: '/space/green-energy/challenges/renewable-energy' },
  { id: 'sub-2', name: 'Urban Mobility Lab', tagline: 'Sustainable transport and smart mobility solutions', bannerUrl: SUBSPACE_BANNERS[1], tags: ['mobility', 'transport', 'smart-city'], isPrivate: false, isMember: true, isPinned: false, leads: [{ name: 'David Kim', avatarUrl: AVATARS.david }], href: '/space/green-energy/challenges/urban-mobility' },
  { id: 'sub-3', name: 'Green Infrastructure', tagline: 'Nature-based solutions for urban resilience', bannerUrl: SUBSPACE_BANNERS[2], tags: ['infrastructure', 'nature', 'resilience'], isPrivate: false, isMember: false, isPinned: false, leads: [{ name: 'Emily Davis' }], href: '/space/green-energy/challenges/green-infrastructure' },
  { id: 'sub-4', name: 'Policy Frameworks', tagline: 'Regulatory and compliance frameworks', bannerUrl: SUBSPACE_BANNERS[3], tags: ['policy', 'regulation', 'compliance'], isPrivate: true, isMember: false, isPinned: false, leads: [{ name: 'Policy Institute' }], href: '/space/green-energy/challenges/policy-frameworks' },
  { id: 'sub-5', name: 'Community Engagement', tagline: 'Citizen participation and stakeholder dialogue', bannerUrl: SUBSPACE_BANNERS[4], tags: ['community', 'engagement', 'participation'], isPrivate: false, isMember: true, isPinned: true, leads: [{ name: 'Anna Martinez', avatarUrl: AVATARS.maya }], href: '/space/green-energy/challenges/community-engagement' },
  { id: 'sub-6', name: 'Digital Twin Project', tagline: 'Digital modelling of urban energy systems', bannerUrl: SUBSPACE_BANNERS[5], tags: ['digital', 'modelling', 'technology'], isPrivate: false, isMember: false, isPinned: false, leads: [{ name: 'Robert Fox', avatarUrl: AVATARS.robert }], href: '/space/green-energy/challenges/digital-twin' },
];

// ── Sidebar ──────────────────────────────────────────

export const MOCK_SIDEBAR = {
  description: 'Collaborating on the future of sustainable energy solutions and urban transformation. Join our community of innovators working to solve real-world challenges.',
  subspaces: [
    { name: 'Renewable Energy', initials: 'RE', color: 'var(--chart-1)', href: '/space/green-energy/challenges/renewable-energy' },
    { name: 'Urban Planning', initials: 'UP', color: 'var(--chart-2)', href: '/space/green-energy/challenges/urban-planning' },
    { name: 'Transportation', initials: 'TR', color: 'var(--chart-3)', href: '/space/green-energy/challenges/transportation' },
  ],
  lead: {
    name: 'Elena Martinez',
    avatarUrl: 'https://images.unsplash.com/photo-1623853589874-864b1dd4d922?auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
    initials: 'EM',
  ...
  virtualContributors: [
    { name: 'Sustainability Advisor', description: 'AI assistant trained on sustainability frameworks and best practices.', avatarUrl: undefined, initials: 'SA' },
    { name: 'Policy Researcher', description: 'Specialises in regulatory and policy analysis for urban environments.', avatarUrl: undefined, initials: 'PR' },
  ],
  knowledgeEntries: [
