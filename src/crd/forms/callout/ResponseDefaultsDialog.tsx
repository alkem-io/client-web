        ...
        <div className="flex-1 overflow-y-auto px-6 py-4 space-y-4 min-w-0">
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              disabled={disabled}
              className="w-full h-9 px-3 border border-border rounded-md bg-input-background focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:opacity-60"
            />
          </div>
