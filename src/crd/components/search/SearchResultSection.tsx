...
export const SearchResultSection = React.forwardRef<HTMLElement, SearchResultSectionProps>(
  (
    { id, icon: Icon, label, count, filterOptions, activeFilter, onFilterChange, hasMore, onLoadMore, children },
    ref
  ) => {
