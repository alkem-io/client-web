...
export function MemoDisplayName({
  displayName,
  value,
  readOnly,
  editing,
    ...
    return (
      <div className="flex items-center gap-1 min-w-0">
        ...
        <Button
          ...
          onClick={onSave}
          disabled={saving}
          aria-label={t('memo.displayName.save')}
        >
          {saving ? (
        ...
        <Button
          ...
          className="size-8 shrink-0"
          onClick={onCancel}
          aria-label={t('memo.displayName.cancel')}
        >
          <X className="size-4" />
        </Button>
      </div>
  ...
  return (
    <div className="flex items-center gap-1 min-w-0">
      ...
      <Button
        ...
        className="size-8 shrink-0"
        onClick={onEdit}
        aria-label={t('memo.displayName.edit')}
      >
