...
/**
 * Shared resource-tab union for the profile pages (User + Organization).
 * Both use the same 3 tabs: Resources Hosted (default), Leading, Member of.
 */
...
/**
 * Sticky horizontal tab strip used at the top of the right column on the
 * User and Organization profile pages. Keyboard-navigable per FR-111
 * (Tab into the strip, Left/Right arrows between tabs, Enter to activate).
