...
const spaceConversionHook = {
  ...
  levelZeroSpaceId: undefined as unknown,
  accountOwnerName: undefined,
  ...
  movedSpaceUrl: undefined,
  targetL0Spaces: [],
  targetL0Loading: false,
  targetL0ExcludeIds: [] as string[],
  targetL1Subspaces: [],
  targetL1Loading: false,
  selectedTargetL0Id: '',
  setSelectedTargetL0Id: vi.fn(),
  handleResolve: vi.fn(),
  handlePromoteL1ToL0: vi.fn(),
  handleDemoteL1ToL2: vi.fn(),
  handlePromoteL2ToL1: vi.fn(),
  moveL1ToL0: vi.fn().mockResolvedValue(undefined),
  moveL1ToL2: vi.fn().mockResolvedValue(undefined),
  moveL2ToL1: vi.fn().mockResolvedValue(undefined),
};
