...
export function useCrdMemoProvider({ collaborationId }: UseCrdMemoProviderProps) {
  ...
  return {
    ...
    hasEverSynced: collab.hasEverSynced,
    hasUnconfirmedLocalChanges: collab.hasUnconfirmedLocalChanges,
    ...
    retryNow: collab.retryNow,
    persistPendingChanges: collab.persistPendingChanges,
    memberCount,
    connectedUsers,
