...
export type ApplicationReceivedKeySpecifier = ('applicationID' | 'communityID' | 'userID' | ApplicationReceivedKeySpecifier)[];
...
export type ApplicationResultEntryKeySpecifier = ('challengeID' | 'communityID' | 'createdDate' | 'displayName' | 'ecoverseID' | 'id' | 'opportunityID' | 'state' | 'updatedDate' | ApplicationResultEntryKeySpecifier)[];
...
export type AuthorizationKeySpecifier = ('anonymousReadAccess' | 'credentialRules' | 'id' | 'myPrivileges' | 'verifiedCredentialRules' | AuthorizationKeySpecifier)[];
...
export type AuthorizationPolicyRuleCredentialKeySpecifier = ('grantedPrivileges' | 'resourceID' | 'type' | AuthorizationPolicyRuleCredentialKeySpecifier)[];
...
export type CanvasKeySpecifier = ('authorization' | 'checkout' | 'id' | 'isTemplate' | 'name' | 'value' | CanvasKeySpecifier)[];
...
export type ChallengeKeySpecifier = ('activity' | 'agent' | 'authorization' | 'challenges' | 'community' | 'context' | 'displayName' | 'ecoverseID' | 'id' | 'leadOrganizations' | 'lifecycle' | 'nameID' | 'opportunities' | 'tagset' | ChallengeKeySpecifier)[];
...
export type CommunicationAdminRoomMembershipResultKeySpecifier = ('displayName' | 'extraMembers' | 'id' | 'members' | 'missingMembers' | 'roomID' | CommunicationAdminRoomMembershipResultKeySpecifier)[];
...
export type CommunicationMessageReceivedKeySpecifier = ('communityId' | 'message' | 'roomId' | 'roomName' | 'userID' | CommunicationMessageReceivedKeySpecifier)[];
...
export type CommunityKeySpecifier = ('applications' | 'authorization' | 'communication' | 'displayName' | 'groups' | 'id' | 'members' | CommunityKeySpecifier)[];
...
export type ContextKeySpecifier = ('aspects' | 'authorization' | 'background' | 'canvases' | 'ecosystemModel' | 'id' | 'impact' | 'references' | 'tagline' | 'vision' | 'visual' | 'who' | ContextKeySpecifier)[];
...
export type EcosystemModelKeySpecifier = ('actorGroups' | 'authorization' | 'canvas' | 'description' | 'id' | EcosystemModelKeySpecifier)[];
...
export type EcoverseKeySpecifier = ('activity' | 'agent' | 'application' | 'authorization' | 'challenge' | 'challenges' | 'community' | 'context' | 'displayName' | 'group' | 'groups' | 'groupsWithTag' | 'host' | 'id' | 'nameID' | 'opportunities' | 'opportunity' | 'project' | 'projects' | 'tagset' | EcoverseKeySpecifier)[];
...
export type MembershipCommunityResultEntryKeySpecifier = ('displayName' | 'id' | MembershipCommunityResultEntryKeySpecifier)[];
export type MembershipCommunityResultEntryFieldPolicy = {
	displayName?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>
};
export type MembershipOrganizationResultEntryChallengeKeySpecifier = ('displayName' | 'ecoverseID' | 'id' | 'nameID' | MembershipOrganizationResultEntryChallengeKeySpecifier)[];
...
export type MembershipUserResultEntryEcoverseKeySpecifier = ('challenges' | 'displayName' | 'ecoverseID' | 'id' | 'nameID' | 'opportunities' | 'userGroups' | MembershipUserResultEntryEcoverseKeySpecifier)[];
...
export type MembershipUserResultEntryOrganizationKeySpecifier = ('displayName' | 'id' | 'nameID' | 'organizationID' | 'userGroups' | MembershipUserResultEntryOrganizationKeySpecifier)[];
...
export type MutationKeySpecifier = ('adminCommunicationEnsureAccessToCommunications' | 'adminCommunicationRemoveOrphanedRoom' | 'assignUserAsChallengeAdmin' | 'assignUserAsEcoverseAdmin' | 'assignUserAsGlobalAdmin' | 'assignUserAsGlobalCommunityAdmin' | 'assignUserAsOpportunityAdmin' | 'assignUserAsOrganizationAdmin' | 'assignUserAsOrganizationOwner' | 'assignUserToCommunity' | 'assignUserToGroup' | 'assignUserToOrganization' | 'authorizationPolicyResetOnEcoverse' | 'authorizationPolicyResetOnOrganization' | 'authorizationPolicyResetOnUser' | 'authorizeStateModificationOnChallenge' | 'createActor' | 'createActorGroup' | 'createApplication' | 'createAspect' | 'createCanvasOnContext' | 'createChallenge' | 'createChildChallenge' | 'createDiscussion' | 'createEcoverse' | 'createGroupOnCommunity' | 'createGroupOnOrganization' | 'createOpportunity' | 'createOrganization' | 'createProject' | 'createReferenceOnContext' | 'createReferenceOnProfile' | 'createRelation' | 'createTagsetOnProfile' | 'createUser' | 'createUserNewRegistration' | 'deleteActor' | 'deleteActorGroup' | 'deleteAspect' | 'deleteCanvasOnContext' | 'deleteChallenge' | 'deleteDiscussion' | 'deleteEcoverse' | 'deleteOpportunity' | 'deleteOrganization' | 'deleteProject' | 'deleteReference' | 'deleteRelation' | 'deleteUser' | 'deleteUserApplication' | 'deleteUserGroup' | 'eventOnApplication' | 'eventOnCanvasCheckout' | 'eventOnChallenge' | 'eventOnOpportunity' | 'eventOnOrganizationVerification' | 'eventOnProject' | 'grantCredentialToUser' | 'messageUser' | 'removeMessageFromDiscussion' | 'removeUpdate' | 'removeUserAsChallengeAdmin' | 'removeUserAsEcoverseAdmin' | 'removeUserAsGlobalAdmin' | 'removeUserAsGlobalCommunityAdmin' | 'removeUserAsOpportunityAdmin' | 'removeUserAsOrganizationAdmin' | 'removeUserAsOrganizationOwner' | 'removeUserFromCommunity' | 'removeUserFromGroup' | 'removeUserFromOrganization' | 'revokeCredentialFromUser' | 'sendMessageToDiscussion' | 'sendUpdate' | 'updateActor' | 'updateAspect' | 'updateCanvas' | 'updateChallenge' | 'updateDiscussion' | 'updateEcosystemModel' | 'updateEcoverse' | 'updateOpportunity' | 'updateOrganization' | 'updateProfile' | 'updateProject' | 'updateUser' | 'updateUserGroup' | 'updateUserPreference' | 'uploadAvatar' | MutationKeySpecifier)[];
...
export type OpportunityKeySpecifier = ('activity' | 'authorization' | 'challenge' | 'community' | 'context' | 'displayName' | 'id' | 'lifecycle' | 'nameID' | 'parentId' | 'parentNameID' | 'projects' | 'relations' | 'tagset' | OpportunityKeySpecifier)[];
...
export type OpportunityTemplateKeySpecifier = ('actorGroups' | 'applications' | 'aspects' | 'name' | 'relations' | OpportunityTemplateKeySpecifier)[];
...
export type OrganizationKeySpecifier = ('activity' | 'agent' | 'authorization' | 'contactEmail' | 'displayName' | 'domain' | 'group' | 'groups' | 'id' | 'legalEntityName' | 'members' | 'nameID' | 'profile' | 'verification' | 'website' | OrganizationKeySpecifier)[];
...
export type OrganizationMembershipKeySpecifier = ('challengesLeading' | 'ecoversesHosting' | 'id' | OrganizationMembershipKeySpecifier)[];
...
export type PlatformKeySpecifier = ('about' | 'featureFlags' | 'feedback' | 'privacy' | 'security' | 'support' | 'terms' | PlatformKeySpecifier)[];
...
export type ProfileKeySpecifier = ('authorization' | 'avatar' | 'description' | 'id' | 'references' | 'tagsets' | ProfileKeySpecifier)[];
...
export type QueryKeySpecifier = ('adminCommunicationMembership' | 'adminCommunicationOrphanedUsage' | 'configuration' | 'ecoverse' | 'ecoverses' | 'me' | 'meHasProfile' | 'membershipOrganization' | 'membershipUser' | 'metadata' | 'organization' | 'organizations' | 'search' | 'user' | 'userAuthorizationPrivileges' | 'users' | 'usersById' | 'usersWithAuthorizationCredential' | QueryKeySpecifier)[];
...
export type SubscriptionKeySpecifier = ('applicationReceived' | 'messageReceived' | 'roomNotificationReceived' | SubscriptionKeySpecifier)[];
...
export type TemplateKeySpecifier = ('challenges' | 'description' | 'ecoverses' | 'name' | 'opportunities' | 'organizations' | 'users' | TemplateKeySpecifier)[];
...
export type UserKeySpecifier = ('accountUpn' | 'agent' | 'authorization' | 'city' | 'communityRooms' | 'country' | 'directRooms' | 'displayName' | 'email' | 'firstName' | 'gender' | 'id' | 'lastName' | 'nameID' | 'phone' | 'preferences' | 'profile' | UserKeySpecifier)[];
...
export type UserMembershipKeySpecifier = ('applications' | 'communities' | 'ecoverses' | 'id' | 'organizations' | UserMembershipKeySpecifier)[];
...
export type UserPreferenceKeySpecifier = ('authorization' | 'definition' | 'id' | 'value' | UserPreferenceKeySpecifier)[];
...
export type UserPreferenceDefinitionKeySpecifier = ('description' | 'displayName' | 'group' | 'id' | 'type' | 'valueType' | UserPreferenceDefinitionKeySpecifier)[];
...
export type VerifiedCredentialKeySpecifier = ('claim' | 'issued' | 'issuer' | 'type' | VerifiedCredentialKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	CommunicationMessageReceived?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | CommunicationMessageReceivedKeySpecifier | (() => undefined | CommunicationMessageReceivedKeySpecifier),
	...
	MembershipCommunityResultEntry?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | MembershipCommunityResultEntryKeySpecifier | (() => undefined | MembershipCommunityResultEntryKeySpecifier),
	...
	MembershipOrganizationResultEntryChallenge?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | MembershipOrganizationResultEntryChallengeKeySpecifier | (() => undefined | MembershipOrganizationResultEntryChallengeKeySpecifier),
	...
	MembershipUserResultEntryEcoverse?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | MembershipUserResultEntryEcoverseKeySpecifier | (() => undefined | MembershipUserResultEntryEcoverseKeySpecifier),
	...
	MembershipUserResultEntryOrganization?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | MembershipUserResultEntryOrganizationKeySpecifier | (() => undefined | MembershipUserResultEntryOrganizationKeySpecifier),
