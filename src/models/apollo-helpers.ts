...
export type ActivityKeySpecifier = ('collaborationID' | 'createdDate' | 'description' | 'id' | 'resourceID' | 'triggeredBy' | 'type' | ActivityKeySpecifier)[];
...
export type ActorKeySpecifier = ('authorization' | 'description' | 'id' | 'impact' | 'name' | 'value' | ActorKeySpecifier)[];
...
export type ActorGroupKeySpecifier = ('actors' | 'authorization' | 'description' | 'id' | 'name' | ActorGroupKeySpecifier)[];
...
export type AgentKeySpecifier = ('authorization' | 'credentials' | 'did' | 'id' | 'verifiedCredentials' | AgentKeySpecifier)[];
...
export type ApplicationKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'lifecycle' | 'questions' | 'updatedDate' | 'user' | ApplicationKeySpecifier)[];
...
export type ApplicationForRoleResultKeySpecifier = ('challengeID' | 'communityID' | 'createdDate' | 'displayName' | 'hubID' | 'id' | 'opportunityID' | 'state' | 'updatedDate' | ApplicationForRoleResultKeySpecifier)[];
...
export type AspectKeySpecifier = ('authorization' | 'banner' | 'bannerNarrow' | 'comments' | 'createdBy' | 'createdDate' | 'description' | 'displayName' | 'id' | 'nameID' | 'references' | 'tagset' | 'type' | AspectKeySpecifier)[];
...
export type AspectCommentsMessageReceivedKeySpecifier = ('aspectID' | 'message' | AspectCommentsMessageReceivedKeySpecifier)[];
export type AspectCommentsMessageReceivedFieldPolicy = {
	aspectID?: FieldPolicy<any> | FieldReadFunction<any>,
	message?: FieldPolicy<any> | FieldReadFunction<any>
};
export type AspectTemplateKeySpecifier = ('authorization' | 'defaultDescription' | 'id' | 'info' | 'type' | AspectTemplateKeySpecifier)[];
...
export type AuthorizationKeySpecifier = ('anonymousReadAccess' | 'credentialRules' | 'id' | 'myPrivileges' | 'privilegeRules' | 'verifiedCredentialRules' | AuthorizationKeySpecifier)[];
...
export type AuthorizationPolicyRuleCredentialKeySpecifier = ('grantedPrivileges' | 'inheritable' | 'resourceID' | 'type' | AuthorizationPolicyRuleCredentialKeySpecifier)[];
...
export type AuthorizationPolicyRulePrivilegeKeySpecifier = ('grantedPrivileges' | 'sourcePrivilege' | AuthorizationPolicyRulePrivilegeKeySpecifier)[];
...
export type CalloutKeySpecifier = ('aspects' | 'authorization' | 'canvases' | 'comments' | 'description' | 'displayName' | 'id' | 'nameID' | 'sortOrder' | 'state' | 'type' | 'visibility' | CalloutKeySpecifier)[];
...
export type CalloutMessageReceivedKeySpecifier = ('calloutID' | 'commentsID' | 'message' | CalloutMessageReceivedKeySpecifier)[];
export type CalloutMessageReceivedFieldPolicy = {
	calloutID?: FieldPolicy<any> | FieldReadFunction<any>,
	commentsID?: FieldPolicy<any> | FieldReadFunction<any>,
	message?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CanvasKeySpecifier = ('authorization' | 'checkout' | 'createdBy' | 'createdDate' | 'displayName' | 'id' | 'nameID' | 'preview' | 'value' | CanvasKeySpecifier)[];
...
export type CanvasCheckoutKeySpecifier = ('authorization' | 'id' | 'lifecycle' | 'lockedBy' | 'status' | CanvasCheckoutKeySpecifier)[];
...
export type ChallengeKeySpecifier = ('activity' | 'agent' | 'authorization' | 'challenges' | 'collaboration' | 'community' | 'context' | 'displayName' | 'hubID' | 'id' | 'lifecycle' | 'nameID' | 'opportunities' | 'preferences' | 'tagset' | ChallengeKeySpecifier)[];
...
export type CollaborationKeySpecifier = ('authorization' | 'callouts' | 'id' | 'relations' | CollaborationKeySpecifier)[];
...
export type CommunicationKeySpecifier = ('authorization' | 'discussion' | 'discussions' | 'id' | 'updates' | CommunicationKeySpecifier)[];
...
export type CommunicationDiscussionMessageReceivedKeySpecifier = ('discussionID' | 'message' | CommunicationDiscussionMessageReceivedKeySpecifier)[];
...
export type CommunicationUpdateMessageReceivedKeySpecifier = ('message' | 'updatesID' | CommunicationUpdateMessageReceivedKeySpecifier)[];
export type CommunicationUpdateMessageReceivedFieldPolicy = {
	message?: FieldPolicy<any> | FieldReadFunction<any>,
	updatesID?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CommunityKeySpecifier = ('applications' | 'authorization' | 'availableLeadUsers' | 'availableMemberUsers' | 'communication' | 'displayName' | 'groups' | 'id' | 'leadOrganizations' | 'leadUsers' | 'memberOrganizations' | 'memberUsers' | 'policy' | CommunityKeySpecifier)[];
...
export type CommunityPolicyRoleKeySpecifier = ('credential' | 'maxOrg' | 'maxUser' | 'minOrg' | 'minUser' | CommunityPolicyRoleKeySpecifier)[];
...
export type ContextKeySpecifier = ('authorization' | 'background' | 'ecosystemModel' | 'id' | 'impact' | 'location' | 'references' | 'tagline' | 'vision' | 'visuals' | 'who' | ContextKeySpecifier)[];
...
export type ContributorRolesKeySpecifier = ('applications' | 'hubs' | 'id' | 'organizations' | ContributorRolesKeySpecifier)[];
...
export type DiscussionKeySpecifier = ('authorization' | 'category' | 'commentsCount' | 'createdBy' | 'description' | 'id' | 'messages' | 'timestamp' | 'title' | DiscussionKeySpecifier)[];
...
export type EcosystemModelKeySpecifier = ('actorGroups' | 'authorization' | 'description' | 'id' | EcosystemModelKeySpecifier)[];
...
export type HubKeySpecifier = ('activity' | 'agent' | 'application' | 'authorization' | 'challenge' | 'challenges' | 'collaboration' | 'community' | 'context' | 'displayName' | 'group' | 'groups' | 'groupsWithTag' | 'host' | 'id' | 'nameID' | 'opportunities' | 'opportunity' | 'preferences' | 'project' | 'projects' | 'tagset' | 'templates' | HubKeySpecifier)[];
...
export type HubAspectTemplateKeySpecifier = ('defaultDescription' | 'type' | 'typeDescription' | HubAspectTemplateKeySpecifier)[];
export type HubAspectTemplateFieldPolicy = {
	defaultDescription?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>,
	typeDescription?: FieldPolicy<any> | FieldReadFunction<any>
};
export type LifecycleKeySpecifier = ('id' | 'machineDef' | 'nextEvents' | 'state' | 'stateIsFinal' | 'templateName' | LifecycleKeySpecifier)[];
...
export type LifecycleTemplateKeySpecifier = ('authorization' | 'definition' | 'id' | 'info' | 'type' | LifecycleTemplateKeySpecifier)[];
...
export type MutationKeySpecifier = ('adminCommunicationEnsureAccessToCommunications' | 'adminCommunicationRemoveOrphanedRoom' | 'adminCommunicationUpdateRoomsJoinRule' | 'applyForCommunityMembership' | 'assignOrganizationAsCommunityLead' | 'assignOrganizationAsCommunityMember' | 'assignUserAsChallengeAdmin' | 'assignUserAsCommunityLead' | 'assignUserAsCommunityMember' | 'assignUserAsGlobalAdmin' | 'assignUserAsGlobalCommunityAdmin' | 'assignUserAsGlobalHubsAdmin' | 'assignUserAsHubAdmin' | 'assignUserAsOpportunityAdmin' | 'assignUserAsOrganizationAdmin' | 'assignUserAsOrganizationOwner' | 'assignUserToGroup' | 'assignUserToOrganization' | 'authorizationPolicyResetOnHub' | 'authorizationPolicyResetOnOrganization' | 'authorizationPolicyResetOnUser' | 'beginAlkemioUserVerifiedCredentialOfferInteraction' | 'beginCommunityMemberVerifiedCredentialOfferInteraction' | 'beginVerifiedCredentialRequestInteraction' | 'convertChallengeToHub' | 'convertOpportunityToChallenge' | 'createActor' | 'createActorGroup' | 'createAspectOnCallout' | 'createAspectTemplate' | 'createCalloutOnCollaboration' | 'createCanvasOnCallout' | 'createCanvasTemplate' | 'createChallenge' | 'createChildChallenge' | 'createDiscussion' | 'createFeedbackOnCommunityContext' | 'createGroupOnCommunity' | 'createGroupOnOrganization' | 'createHub' | 'createLifecycleTemplate' | 'createOpportunity' | 'createOrganization' | 'createProject' | 'createReferenceOnAspect' | 'createReferenceOnContext' | 'createReferenceOnProfile' | 'createRelationOnCollaboration' | 'createTagsetOnProfile' | 'createUser' | 'createUserNewRegistration' | 'deleteActor' | 'deleteActorGroup' | 'deleteAspect' | 'deleteAspectTemplate' | 'deleteCallout' | 'deleteCanvas' | 'deleteCanvasTemplate' | 'deleteChallenge' | 'deleteCollaboration' | 'deleteDiscussion' | 'deleteHub' | 'deleteLifecycleTemplate' | 'deleteOpportunity' | 'deleteOrganization' | 'deleteProject' | 'deleteReference' | 'deleteRelation' | 'deleteUser' | 'deleteUserApplication' | 'deleteUserGroup' | 'eventOnApplication' | 'eventOnCanvasCheckout' | 'eventOnChallenge' | 'eventOnOpportunity' | 'eventOnOrganizationVerification' | 'eventOnProject' | 'grantCredentialToUser' | 'joinCommunity' | 'messageUser' | 'removeComment' | 'removeMessageFromDiscussion' | 'removeOrganizationAsCommunityLead' | 'removeOrganizationAsCommunityMember' | 'removeUpdate' | 'removeUserAsChallengeAdmin' | 'removeUserAsCommunityLead' | 'removeUserAsCommunityMember' | 'removeUserAsGlobalAdmin' | 'removeUserAsGlobalCommunityAdmin' | 'removeUserAsGlobalHubsAdmin' | 'removeUserAsHubAdmin' | 'removeUserAsOpportunityAdmin' | 'removeUserAsOrganizationAdmin' | 'removeUserAsOrganizationOwner' | 'removeUserFromGroup' | 'removeUserFromOrganization' | 'revokeCredentialFromUser' | 'sendComment' | 'sendMessageOnCallout' | 'sendMessageToDiscussion' | 'sendUpdate' | 'updateActor' | 'updateAspect' | 'updateAspectTemplate' | 'updateCallout' | 'updateCanvas' | 'updateCanvasTemplate' | 'updateChallenge' | 'updateChallengeInnovationFlow' | 'updateDiscussion' | 'updateEcosystemModel' | 'updateHub' | 'updateLifecycleTemplate' | 'updateOpportunity' | 'updateOpportunityInnovationFlow' | 'updateOrganization' | 'updatePreferenceOnChallenge' | 'updatePreferenceOnHub' | 'updatePreferenceOnOrganization' | 'updatePreferenceOnUser' | 'updateProfile' | 'updateProject' | 'updateUser' | 'updateUserGroup' | 'updateVisual' | 'uploadImageOnVisual' | MutationKeySpecifier)[];
...
export type OpportunityKeySpecifier = ('activity' | 'authorization' | 'challenge' | 'collaboration' | 'community' | 'context' | 'displayName' | 'id' | 'lifecycle' | 'nameID' | 'parentId' | 'parentNameID' | 'projects' | 'tagset' | OpportunityKeySpecifier)[];
...
export type OpportunityTemplateKeySpecifier = ('actorGroups' | 'applications' | 'name' | 'relations' | OpportunityTemplateKeySpecifier)[];
...
export type OrganizationKeySpecifier = ('activity' | 'agent' | 'authorization' | 'contactEmail' | 'displayName' | 'domain' | 'group' | 'groups' | 'id' | 'legalEntityName' | 'members' | 'nameID' | 'preferences' | 'profile' | 'verification' | 'website' | OrganizationKeySpecifier)[];
...
export type OrganizationVerificationKeySpecifier = ('authorization' | 'id' | 'lifecycle' | 'status' | OrganizationVerificationKeySpecifier)[];
...
export type PlatformKeySpecifier = ('about' | 'featureFlags' | 'feedback' | 'foundation' | 'impact' | 'opensource' | 'privacy' | 'releases' | 'security' | 'support' | 'terms' | PlatformKeySpecifier)[];
...
export type PreferenceDefinitionKeySpecifier = ('description' | 'displayName' | 'group' | 'id' | 'type' | 'valueType' | PreferenceDefinitionKeySpecifier)[];
...
export type ProfileKeySpecifier = ('authorization' | 'avatar' | 'description' | 'id' | 'location' | 'references' | 'tagsets' | ProfileKeySpecifier)[];
...
export type ProjectKeySpecifier = ('authorization' | 'description' | 'displayName' | 'id' | 'lifecycle' | 'nameID' | 'tagset' | ProjectKeySpecifier)[];
...
export type QueryKeySpecifier = ('activityLogOnCollaboration' | 'adminCommunicationMembership' | 'adminCommunicationOrphanedUsage' | 'authorization' | 'configuration' | 'getSupportedVerifiedCredentialMetadata' | 'hub' | 'hubs' | 'me' | 'meHasProfile' | 'metadata' | 'organization' | 'organizations' | 'organizationsPaginated' | 'rolesOrganization' | 'rolesUser' | 'search' | 'user' | 'userAuthorizationPrivileges' | 'users' | 'usersById' | 'usersPaginated' | 'usersWithAuthorizationCredential' | QueryKeySpecifier)[];
...
export type RelationKeySpecifier = ('actorName' | 'actorRole' | 'actorType' | 'authorization' | 'description' | 'id' | 'type' | RelationKeySpecifier)[];
...
export type RelayPaginatedUserKeySpecifier = ('accountUpn' | 'agent' | 'authorization' | 'communityRooms' | 'directRooms' | 'displayName' | 'email' | 'firstName' | 'gender' | 'id' | 'lastName' | 'nameID' | 'phone' | 'preferences' | 'profile' | RelayPaginatedUserKeySpecifier)[];
...
export type RelayPaginatedUserPageInfoKeySpecifier = ('endCursor' | 'hasNextPage' | 'hasPreviousPage' | 'startCursor' | RelayPaginatedUserPageInfoKeySpecifier)[];
...
export type RolesResultCommunityKeySpecifier = ('displayName' | 'id' | 'nameID' | 'roles' | 'userGroups' | RolesResultCommunityKeySpecifier)[];
...
export type RolesResultHubKeySpecifier = ('challenges' | 'displayName' | 'hubID' | 'id' | 'nameID' | 'opportunities' | 'roles' | 'userGroups' | RolesResultHubKeySpecifier)[];
...
export type SubscriptionKeySpecifier = ('aspectCommentsMessageReceived' | 'calloutAspectCreated' | 'calloutMessageReceived' | 'canvasContentUpdated' | 'communicationDiscussionMessageReceived' | 'communicationDiscussionUpdated' | 'communicationUpdateMessageReceived' | 'profileVerifiedCredential' | SubscriptionKeySpecifier)[];
...
export type TemplateKeySpecifier = ('challenges' | 'description' | 'hubs' | 'name' | 'opportunities' | 'organizations' | 'users' | TemplateKeySpecifier)[];
...
export type TemplateInfoKeySpecifier = ('description' | 'id' | 'tagset' | 'title' | 'visual' | TemplateInfoKeySpecifier)[];
...
export type TemplatesSetKeySpecifier = ('aspectTemplate' | 'aspectTemplates' | 'authorization' | 'canvasTemplate' | 'canvasTemplates' | 'id' | 'lifecycleTemplate' | 'lifecycleTemplates' | TemplatesSetKeySpecifier)[];
...
export type UserKeySpecifier = ('accountUpn' | 'agent' | 'authorization' | 'communityRooms' | 'directRooms' | 'displayName' | 'email' | 'firstName' | 'gender' | 'id' | 'lastName' | 'nameID' | 'phone' | 'preferences' | 'profile' | UserKeySpecifier)[];
...
export type UserGroupKeySpecifier = ('authorization' | 'id' | 'members' | 'name' | 'parent' | 'profile' | UserGroupKeySpecifier)[];
...
export type VisualKeySpecifier = ('allowedTypes' | 'aspectRatio' | 'authorization' | 'id' | 'maxHeight' | 'maxWidth' | 'minHeight' | 'minWidth' | 'name' | 'uri' | VisualKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	AspectCommentsMessageReceived?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | AspectCommentsMessageReceivedKeySpecifier | (() => undefined | AspectCommentsMessageReceivedKeySpecifier),
	...
	CommunicationDiscussionMessageReceived?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunicationDiscussionMessageReceivedKeySpecifier | (() => undefined | CommunicationDiscussionMessageReceivedKeySpecifier),
	...
	CommunicationUpdateMessageReceived?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunicationUpdateMessageReceivedKeySpecifier | (() => undefined | CommunicationUpdateMessageReceivedKeySpecifier),
	...
	RelayPaginatedUserPageInfo?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | RelayPaginatedUserPageInfoKeySpecifier | (() => undefined | RelayPaginatedUserPageInfoKeySpecifier),
