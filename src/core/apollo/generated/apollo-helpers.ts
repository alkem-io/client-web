...
export type AccountKeySpecifier = ('accountType' | 'actor' | 'authorization' | 'baselineLicensePlan' | 'createdDate' | 'credentials' | 'externalSubscriptionID' | 'host' | 'id' | 'innovationHubs' | 'innovationPacks' | 'license' | 'nameID' | 'profile' | 'spaces' | 'storageAggregator' | 'subscriptions' | 'type' | 'updatedDate' | 'virtualContributors' | AccountKeySpecifier)[];
...
export type AccountLicensePlanKeySpecifier = ('innovationPacks' | 'spaceFree' | 'spacePlus' | 'spacePremium' | 'startingPages' | 'virtualContributor' | AccountLicensePlanKeySpecifier)[];
...
export type ActivityCreatedSubscriptionResultKeySpecifier = ('activity' | ActivityCreatedSubscriptionResultKeySpecifier)[];
...
export type ActivityLogEntryKeySpecifier = ('child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryKeySpecifier)[];
...
export type ActivityLogEntryCalendarEventCreatedKeySpecifier = ('calendar' | 'calendarEvent' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryCalendarEventCreatedKeySpecifier)[];
...
export type ActivityLogEntryCalloutDiscussionCommentKeySpecifier = ('callout' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryCalloutDiscussionCommentKeySpecifier)[];
...
export type ActivityLogEntryCalloutLinkCreatedKeySpecifier = ('callout' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'link' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryCalloutLinkCreatedKeySpecifier)[];
...
export type ActivityLogEntryCalloutMemoCreatedKeySpecifier = ('callout' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'memo' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryCalloutMemoCreatedKeySpecifier)[];
...
export type ActivityLogEntryCalloutPostCommentKeySpecifier = ('callout' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'post' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryCalloutPostCommentKeySpecifier)[];
...
export type ActivityLogEntryCalloutPostCreatedKeySpecifier = ('callout' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'post' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryCalloutPostCreatedKeySpecifier)[];
...
export type ActivityLogEntryCalloutPublishedKeySpecifier = ('callout' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryCalloutPublishedKeySpecifier)[];
...
export type ActivityLogEntryCalloutWhiteboardContentModifiedKeySpecifier = ('callout' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | 'whiteboard' | ActivityLogEntryCalloutWhiteboardContentModifiedKeySpecifier)[];
...
export type ActivityLogEntryCalloutWhiteboardCreatedKeySpecifier = ('callout' | 'child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | 'whiteboard' | ActivityLogEntryCalloutWhiteboardCreatedKeySpecifier)[];
...
export type ActivityLogEntryMemberJoinedKeySpecifier = ('actor' | 'actorType' | 'child' | 'collaborationID' | 'community' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryMemberJoinedKeySpecifier)[];
...
export type ActivityLogEntrySubspaceCreatedKeySpecifier = ('child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'subspace' | 'triggeredBy' | 'type' | ActivityLogEntrySubspaceCreatedKeySpecifier)[];
...
export type ActivityLogEntryUpdateSentKeySpecifier = ('child' | 'collaborationID' | 'createdDate' | 'description' | 'id' | 'journeyUrl' | 'message' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | 'updates' | ActivityLogEntryUpdateSentKeySpecifier)[];
...
export type ActorKeySpecifier = ('authorization' | 'createdDate' | 'credentials' | 'id' | 'nameID' | 'profile' | 'type' | 'updatedDate' | ActorKeySpecifier)[];
...
export type ActorFullKeySpecifier = ('authorization' | 'createdDate' | 'credentials' | 'id' | 'nameID' | 'profile' | 'type' | 'updatedDate' | ActorFullKeySpecifier)[];
...
export type ActorRolesKeySpecifier = ('applications' | 'id' | 'invitations' | 'organizations' | 'spaces' | ActorRolesKeySpecifier)[];
...
export type AiPersonaKeySpecifier = ('authorization' | 'bodyOfKnowledgeLastUpdated' | 'createdDate' | 'engine' | 'externalConfig' | 'id' | 'prompt' | 'promptGraph' | 'updatedDate' | AiPersonaKeySpecifier)[];
...
export type AiServerKeySpecifier = ('aiPersona' | 'aiPersonas' | 'authorization' | 'createdDate' | 'defaultAiPersona' | 'id' | 'updatedDate' | AiServerKeySpecifier)[];
...
export type ApplicationKeySpecifier = ('actor' | 'authorization' | 'createdDate' | 'id' | 'isFinalized' | 'lifecycle' | 'nextEvents' | 'questions' | 'state' | 'updatedDate' | ApplicationKeySpecifier)[];
...
export type AuthenticationProviderConfigKeySpecifier = ('config' | 'enabled' | 'icon' | 'label' | 'name' | AuthenticationProviderConfigKeySpecifier)[];
...
export type AuthorizationKeySpecifier = ('createdDate' | 'credentialRules' | 'hasPrivilege' | 'id' | 'myPrivileges' | 'privilegeRules' | 'type' | 'updatedDate' | AuthorizationKeySpecifier)[];
...
export type AuthorizationPolicyRuleCredentialKeySpecifier = ('cascade' | 'criterias' | 'grantedPrivileges' | 'name' | AuthorizationPolicyRuleCredentialKeySpecifier)[];
...
export type AuthorizationPolicyRulePrivilegeKeySpecifier = ('grantedPrivileges' | 'name' | 'sourcePrivilege' | AuthorizationPolicyRulePrivilegeKeySpecifier)[];
export type AuthorizationPolicyRulePrivilegeFieldPolicy = {
	grantedPrivileges?: FieldPolicy<any> | FieldReadFunction<any>,
	name?: FieldPolicy<any> | FieldReadFunction<any>,
	sourcePrivilege?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CalendarKeySpecifier = ('authorization' | 'createdDate' | 'event' | 'events' | 'id' | 'updatedDate' | CalendarKeySpecifier)[];
...
export type CalendarEventKeySpecifier = ('authorization' | 'comments' | 'createdBy' | 'createdDate' | 'durationDays' | 'durationMinutes' | 'googleCalendarUrl' | 'icsDownloadUrl' | 'id' | 'multipleDays' | 'nameID' | 'outlookCalendarUrl' | 'profile' | 'startDate' | 'subspace' | 'type' | 'updatedDate' | 'visibleOnParentCalendar' | 'wholeDay' | CalendarEventKeySpecifier)[];
...
export type CalloutKeySpecifier = ('activity' | 'authorization' | 'classification' | 'comments' | 'contributionDefaults' | 'contributions' | 'contributionsCount' | 'createdBy' | 'createdDate' | 'framing' | 'id' | 'isTemplate' | 'nameID' | 'posts' | 'publishedBy' | 'publishedDate' | 'settings' | 'sortOrder' | 'updatedDate' | CalloutKeySpecifier)[];
...
export type CalloutContributionKeySpecifier = ('authorization' | 'createdBy' | 'createdDate' | 'id' | 'link' | 'memo' | 'post' | 'sortOrder' | 'updatedDate' | 'whiteboard' | CalloutContributionKeySpecifier)[];
...
export type CalloutContributionDefaultsKeySpecifier = ('createdDate' | 'defaultDisplayName' | 'id' | 'postDescription' | 'updatedDate' | 'whiteboardContent' | CalloutContributionDefaultsKeySpecifier)[];
...
export type CalloutContributionsCountOutputKeySpecifier = ('link' | 'memo' | 'post' | 'whiteboard' | CalloutContributionsCountOutputKeySpecifier)[];
...
export type CalloutFramingKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'link' | 'mediaGallery' | 'memo' | 'profile' | 'type' | 'updatedDate' | 'whiteboard' | CalloutFramingKeySpecifier)[];
...
export type CalloutPostCreatedKeySpecifier = ('calloutID' | 'contributionID' | 'post' | 'sortOrder' | CalloutPostCreatedKeySpecifier)[];
...
export type CalloutSettingsContributionKeySpecifier = ('allowedTypes' | 'canAddContributions' | 'commentsEnabled' | 'enabled' | CalloutSettingsContributionKeySpecifier)[];
...
export type CalloutsSetKeySpecifier = ('authorization' | 'callouts' | 'createdDate' | 'id' | 'tags' | 'tagsetTemplates' | 'type' | 'updatedDate' | CalloutsSetKeySpecifier)[];
...
export type ClassificationKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'tagset' | 'tagsets' | 'updatedDate' | ClassificationKeySpecifier)[];
...
export type CollaborationKeySpecifier = ('authorization' | 'calloutsSet' | 'createdDate' | 'id' | 'innovationFlow' | 'isTemplate' | 'license' | 'timeline' | 'updatedDate' | CollaborationKeySpecifier)[];
...
export type CommunicationKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'updatedDate' | 'updates' | CommunicationKeySpecifier)[];
...
export type CommunicationAdminMembershipResultKeySpecifier = ('displayName' | 'id' | 'rooms' | CommunicationAdminMembershipResultKeySpecifier)[];
export type CommunicationAdminMembershipResultFieldPolicy = {
	displayName?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	rooms?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CommunicationAdminMigrateRoomsResultKeySpecifier = ('errors' | 'failed' | 'migrated' | CommunicationAdminMigrateRoomsResultKeySpecifier)[];
...
export type CommunicationAdminOrphanedUsageResultKeySpecifier = ('rooms' | CommunicationAdminOrphanedUsageResultKeySpecifier)[];
export type CommunicationAdminOrphanedUsageResultFieldPolicy = {
	rooms?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CommunicationAdminRoomMembershipResultKeySpecifier = ('displayName' | 'extraMembers' | 'id' | 'joinRule' | 'members' | 'missingMembers' | 'roomID' | CommunicationAdminRoomMembershipResultKeySpecifier)[];
...
export type CommunicationAdminRoomResultKeySpecifier = ('displayName' | 'id' | 'members' | CommunicationAdminRoomResultKeySpecifier)[];
export type CommunicationAdminRoomResultFieldPolicy = {
	displayName?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	members?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CommunityKeySpecifier = ('authorization' | 'communication' | 'createdDate' | 'group' | 'groups' | 'id' | 'roleSet' | 'updatedDate' | CommunityKeySpecifier)[];
...
export type CommunityApplicationForRoleResultKeySpecifier = ('communityID' | 'createdDate' | 'displayName' | 'id' | 'spaceID' | 'spaceLevel' | 'state' | 'updatedDate' | CommunityApplicationForRoleResultKeySpecifier)[];
...
export type CommunityApplicationResultKeySpecifier = ('application' | 'id' | 'spacePendingMembershipInfo' | CommunityApplicationResultKeySpecifier)[];
...
export type CommunityGuidelinesKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'profile' | 'updatedDate' | CommunityGuidelinesKeySpecifier)[];
...
export type CommunityInvitationForRoleResultKeySpecifier = ('actorID' | 'communityID' | 'createdBy' | 'createdDate' | 'displayName' | 'id' | 'spaceID' | 'spaceLevel' | 'state' | 'updatedDate' | 'welcomeMessage' | CommunityInvitationForRoleResultKeySpecifier)[];
...
export type CommunityInvitationResultKeySpecifier = ('id' | 'invitation' | 'spacePendingMembershipInfo' | CommunityInvitationResultKeySpecifier)[];
export type CommunityInvitationResultFieldPolicy = {
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	invitation?: FieldPolicy<any> | FieldReadFunction<any>,
	spacePendingMembershipInfo?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CommunityMembershipResultKeySpecifier = ('childMemberships' | 'id' | 'space' | CommunityMembershipResultKeySpecifier)[];
export type CommunityMembershipResultFieldPolicy = {
	childMemberships?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	space?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ConfigKeySpecifier = ('apm' | 'authentication' | 'defaultVisualTypeConstraints' | 'featureFlags' | 'geo' | 'locations' | 'sentry' | 'storage' | ConfigKeySpecifier)[];
...
export type ConversationKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'members' | 'messaging' | 'room' | 'updatedDate' | ConversationKeySpecifier)[];
...
export type ConversationCreatedEventKeySpecifier = ('conversation' | 'message' | ConversationCreatedEventKeySpecifier)[];
...
export type ConversationEventSubscriptionResultKeySpecifier = ('conversationCreated' | 'conversationDeleted' | 'conversationUpdated' | 'eventType' | 'memberAdded' | 'memberRemoved' | 'messageReceived' | 'messageRemoved' | 'readReceiptUpdated' | ConversationEventSubscriptionResultKeySpecifier)[];
...
export type ConversationMemberAddedEventKeySpecifier = ('addedMember' | 'conversation' | ConversationMemberAddedEventKeySpecifier)[];
export type ConversationMemberAddedEventFieldPolicy = {
	addedMember?: FieldPolicy<any> | FieldReadFunction<any>,
	conversation?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ConversationMemberRemovedEventKeySpecifier = ('conversation' | 'removedMemberID' | ConversationMemberRemovedEventKeySpecifier)[];
export type ConversationMemberRemovedEventFieldPolicy = {
	conversation?: FieldPolicy<any> | FieldReadFunction<any>,
	removedMemberID?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ConversationMessageReceivedEventKeySpecifier = ('message' | 'roomId' | ConversationMessageReceivedEventKeySpecifier)[];
export type ConversationMessageReceivedEventFieldPolicy = {
	message?: FieldPolicy<any> | FieldReadFunction<any>,
	roomId?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ConversationMessageRemovedEventKeySpecifier = ('messageId' | 'roomId' | ConversationMessageRemovedEventKeySpecifier)[];
export type ConversationMessageRemovedEventFieldPolicy = {
	messageId?: FieldPolicy<any> | FieldReadFunction<any>,
	roomId?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ConversationReadReceiptUpdatedEventKeySpecifier = ('lastReadEventId' | 'roomId' | ConversationReadReceiptUpdatedEventKeySpecifier)[];
...
export type CreateCalloutContributionDataKeySpecifier = ('link' | 'memo' | 'post' | 'sortOrder' | 'type' | 'whiteboard' | CreateCalloutContributionDataKeySpecifier)[];
...
export type CreateCalloutContributionDefaultsDataKeySpecifier = ('defaultDisplayName' | 'postDescription' | 'whiteboardContent' | CreateCalloutContributionDefaultsDataKeySpecifier)[];
export type CreateCalloutContributionDefaultsDataFieldPolicy = {
	defaultDisplayName?: FieldPolicy<any> | FieldReadFunction<any>,
	postDescription?: FieldPolicy<any> | FieldReadFunction<any>,
	whiteboardContent?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CreateCalloutDataKeySpecifier = ('classification' | 'contributionDefaults' | 'contributions' | 'framing' | 'nameID' | 'sendNotification' | 'settings' | 'sortOrder' | CreateCalloutDataKeySpecifier)[];
...
export type CreateCalloutFramingDataKeySpecifier = ('link' | 'memo' | 'profile' | 'tags' | 'type' | 'whiteboard' | CreateCalloutFramingDataKeySpecifier)[];
...
export type CreateCalloutSettingsContributionDataKeySpecifier = ('allowedTypes' | 'canAddContributions' | 'commentsEnabled' | 'enabled' | CreateCalloutSettingsContributionDataKeySpecifier)[];
...
export type CreateCalloutSettingsDataKeySpecifier = ('contribution' | 'framing' | 'visibility' | CreateCalloutSettingsDataKeySpecifier)[];
export type CreateCalloutSettingsDataFieldPolicy = {
	contribution?: FieldPolicy<any> | FieldReadFunction<any>,
	framing?: FieldPolicy<any> | FieldReadFunction<any>,
	visibility?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CreateCalloutSettingsFramingDataKeySpecifier = ('commentsEnabled' | CreateCalloutSettingsFramingDataKeySpecifier)[];
...
export type CreateCollaborationDataKeySpecifier = ('calloutsSetData' | 'innovationFlowData' | CreateCollaborationDataKeySpecifier)[];
...
export type CreateInnovationFlowStateDataKeySpecifier = ('description' | 'displayName' | 'settings' | 'sortOrder' | CreateInnovationFlowStateDataKeySpecifier)[];
...
export type CreateInnovationFlowStateSettingsDataKeySpecifier = ('allowNewCallouts' | CreateInnovationFlowStateSettingsDataKeySpecifier)[];
...
export type CreateLocationDataKeySpecifier = ('addressLine1' | 'addressLine2' | 'city' | 'country' | 'postalCode' | 'stateOrProvince' | CreateLocationDataKeySpecifier)[];
...
export type CreateProfileDataKeySpecifier = ('description' | 'displayName' | 'location' | 'referencesData' | 'tagline' | 'tags' | 'tagsets' | 'visuals' | CreateProfileDataKeySpecifier)[];
...
export type CreateWhiteboardDataKeySpecifier = ('content' | 'nameID' | 'previewSettings' | 'profile' | CreateWhiteboardDataKeySpecifier)[];
...
export type CreateWhiteboardPreviewSettingsDataKeySpecifier = ('coordinates' | 'mode' | CreateWhiteboardPreviewSettingsDataKeySpecifier)[];
...
export type CredentialKeySpecifier = ('createdDate' | 'expires' | 'id' | 'issuer' | 'resourceID' | 'type' | 'updatedDate' | CredentialKeySpecifier)[];
...
export type DiscussionKeySpecifier = ('authorization' | 'category' | 'comments' | 'createdBy' | 'createdDate' | 'id' | 'nameID' | 'privacy' | 'profile' | 'timestamp' | 'updatedDate' | DiscussionKeySpecifier)[];
...
export type DiscussionDetailsKeySpecifier = ('category' | 'description' | 'displayName' | 'id' | 'url' | DiscussionDetailsKeySpecifier)[];
...
export type DocumentKeySpecifier = ('authorization' | 'createdBy' | 'createdDate' | 'displayName' | 'id' | 'mimeType' | 'size' | 'tagset' | 'temporaryLocation' | 'updatedDate' | 'uploadedDate' | 'url' | DocumentKeySpecifier)[];
...
export type FormKeySpecifier = ('createdDate' | 'description' | 'id' | 'questions' | 'updatedDate' | FormKeySpecifier)[];
...
export type FormQuestionKeySpecifier = ('explanation' | 'maxLength' | 'question' | 'required' | 'sortOrder' | FormQuestionKeySpecifier)[];
...
export type ForumKeySpecifier = ('authorization' | 'createdDate' | 'discussion' | 'discussionCategories' | 'discussions' | 'id' | 'updatedDate' | ForumKeySpecifier)[];
...
export type ISearchResultsKeySpecifier = ('actorResults' | 'calloutResults' | 'contributionResults' | 'framingResults' | 'spaceResults' | ISearchResultsKeySpecifier)[];
...
export type InAppNotificationKeySpecifier = ('category' | 'createdDate' | 'id' | 'payload' | 'receiver' | 'state' | 'triggeredAt' | 'triggeredBy' | 'type' | 'updatedDate' | InAppNotificationKeySpecifier)[];
...
export type InAppNotificationPayloadOrganizationMessageDirectKeySpecifier = ('message' | 'organization' | 'type' | InAppNotificationPayloadOrganizationMessageDirectKeySpecifier)[];
export type InAppNotificationPayloadOrganizationMessageDirectFieldPolicy = {
	message?: FieldPolicy<any> | FieldReadFunction<any>,
	organization?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadOrganizationMessageRoomKeySpecifier = ('comment' | 'organization' | 'roomID' | 'type' | InAppNotificationPayloadOrganizationMessageRoomKeySpecifier)[];
...
export type InAppNotificationPayloadPlatformForumDiscussionKeySpecifier = ('comment' | 'discussion' | 'type' | InAppNotificationPayloadPlatformForumDiscussionKeySpecifier)[];
export type InAppNotificationPayloadPlatformForumDiscussionFieldPolicy = {
	comment?: FieldPolicy<any> | FieldReadFunction<any>,
	discussion?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadPlatformGlobalRoleChangeKeySpecifier = ('role' | 'type' | 'user' | InAppNotificationPayloadPlatformGlobalRoleChangeKeySpecifier)[];
export type InAppNotificationPayloadPlatformGlobalRoleChangeFieldPolicy = {
	role?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>,
	user?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadPlatformUserKeySpecifier = ('type' | InAppNotificationPayloadPlatformUserKeySpecifier)[];
export type InAppNotificationPayloadPlatformUserFieldPolicy = {
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadPlatformUserMessageRoomKeySpecifier = ('messageDetails' | 'type' | 'user' | InAppNotificationPayloadPlatformUserMessageRoomKeySpecifier)[];
...
export type InAppNotificationPayloadPlatformUserProfileRemovedKeySpecifier = ('type' | 'userDisplayName' | 'userEmail' | InAppNotificationPayloadPlatformUserProfileRemovedKeySpecifier)[];
...
export type InAppNotificationPayloadSpaceKeySpecifier = ('space' | 'type' | InAppNotificationPayloadSpaceKeySpecifier)[];
export type InAppNotificationPayloadSpaceFieldPolicy = {
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadSpaceCollaborationCalloutKeySpecifier = ('callout' | 'space' | 'type' | InAppNotificationPayloadSpaceCollaborationCalloutKeySpecifier)[];
export type InAppNotificationPayloadSpaceCollaborationCalloutFieldPolicy = {
	callout?: FieldPolicy<any> | FieldReadFunction<any>,
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadSpaceCollaborationCalloutCommentKeySpecifier = ('callout' | 'messageDetails' | 'space' | 'type' | InAppNotificationPayloadSpaceCollaborationCalloutCommentKeySpecifier)[];
...
export type InAppNotificationPayloadSpaceCollaborationCalloutPostCommentKeySpecifier = ('callout' | 'messageDetails' | 'space' | 'type' | InAppNotificationPayloadSpaceCollaborationCalloutPostCommentKeySpecifier)[];
...
export type InAppNotificationPayloadSpaceCommunicationMessageDirectKeySpecifier = ('message' | 'space' | 'type' | InAppNotificationPayloadSpaceCommunicationMessageDirectKeySpecifier)[];
export type InAppNotificationPayloadSpaceCommunicationMessageDirectFieldPolicy = {
	message?: FieldPolicy<any> | FieldReadFunction<any>,
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadSpaceCommunicationUpdateKeySpecifier = ('space' | 'type' | 'update' | InAppNotificationPayloadSpaceCommunicationUpdateKeySpecifier)[];
export type InAppNotificationPayloadSpaceCommunicationUpdateFieldPolicy = {
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>,
	update?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadSpaceCommunityActorKeySpecifier = ('actor' | 'space' | 'type' | InAppNotificationPayloadSpaceCommunityActorKeySpecifier)[];
export type InAppNotificationPayloadSpaceCommunityActorFieldPolicy = {
	actor?: FieldPolicy<any> | FieldReadFunction<any>,
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadSpaceCommunityApplicationKeySpecifier = ('application' | 'space' | 'type' | InAppNotificationPayloadSpaceCommunityApplicationKeySpecifier)[];
export type InAppNotificationPayloadSpaceCommunityApplicationFieldPolicy = {
	application?: FieldPolicy<any> | FieldReadFunction<any>,
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadSpaceCommunityCalendarEventKeySpecifier = ('calendarEvent' | 'space' | 'type' | InAppNotificationPayloadSpaceCommunityCalendarEventKeySpecifier)[];
export type InAppNotificationPayloadSpaceCommunityCalendarEventFieldPolicy = {
	calendarEvent?: FieldPolicy<any> | FieldReadFunction<any>,
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadSpaceCommunityCalendarEventCommentKeySpecifier = ('calendarEvent' | 'commentText' | 'space' | 'type' | InAppNotificationPayloadSpaceCommunityCalendarEventCommentKeySpecifier)[];
...
export type InAppNotificationPayloadSpaceCommunityInvitationKeySpecifier = ('space' | 'type' | InAppNotificationPayloadSpaceCommunityInvitationKeySpecifier)[];
export type InAppNotificationPayloadSpaceCommunityInvitationFieldPolicy = {
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadSpaceCommunityInvitationPlatformKeySpecifier = ('space' | 'type' | InAppNotificationPayloadSpaceCommunityInvitationPlatformKeySpecifier)[];
export type InAppNotificationPayloadSpaceCommunityInvitationPlatformFieldPolicy = {
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadUserMessageDirectKeySpecifier = ('message' | 'type' | 'user' | InAppNotificationPayloadUserMessageDirectKeySpecifier)[];
export type InAppNotificationPayloadUserMessageDirectFieldPolicy = {
	message?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>,
	user?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InAppNotificationPayloadVirtualContributorKeySpecifier = ('actor' | 'space' | 'type' | InAppNotificationPayloadVirtualContributorKeySpecifier)[];
export type InAppNotificationPayloadVirtualContributorFieldPolicy = {
	actor?: FieldPolicy<any> | FieldReadFunction<any>,
	space?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type InnovationFlowKeySpecifier = ('authorization' | 'createdDate' | 'currentState' | 'id' | 'profile' | 'settings' | 'states' | 'updatedDate' | InnovationFlowKeySpecifier)[];
...
export type InnovationFlowSettingsKeySpecifier = ('maximumNumberOfStates' | 'minimumNumberOfStates' | InnovationFlowSettingsKeySpecifier)[];
...
export type InnovationFlowStateKeySpecifier = ('authorization' | 'createdDate' | 'defaultCalloutTemplate' | 'description' | 'displayName' | 'id' | 'settings' | 'sortOrder' | 'updatedDate' | InnovationFlowStateKeySpecifier)[];
...
export type InnovationHubKeySpecifier = ('account' | 'authorization' | 'createdDate' | 'id' | 'listedInStore' | 'nameID' | 'profile' | 'provider' | 'searchVisibility' | 'spaceListFilter' | 'spaceVisibilityFilter' | 'subdomain' | 'type' | 'updatedDate' | InnovationHubKeySpecifier)[];
...
export type InnovationPackKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'listedInStore' | 'nameID' | 'profile' | 'provider' | 'searchVisibility' | 'templatesSet' | 'updatedDate' | InnovationPackKeySpecifier)[];
...
export type InputCreatorQueryResultsKeySpecifier = ('callout' | 'collaboration' | 'communityGuidelines' | 'innovationFlow' | 'whiteboard' | InputCreatorQueryResultsKeySpecifier)[];
...
export type InvitationKeySpecifier = ('actor' | 'authorization' | 'createdBy' | 'createdDate' | 'extraRoles' | 'id' | 'invitedToParent' | 'isFinalized' | 'lifecycle' | 'nextEvents' | 'state' | 'updatedDate' | 'welcomeMessage' | InvitationKeySpecifier)[];
...
export type KnowledgeBaseKeySpecifier = ('authorization' | 'calloutsSet' | 'createdDate' | 'id' | 'profile' | 'updatedDate' | KnowledgeBaseKeySpecifier)[];
...
export type KratosIdentityKeySpecifier = ('createdAt' | 'email' | 'firstName' | 'id' | 'isVerified' | 'lastName' | 'verificationStatus' | KratosIdentityKeySpecifier)[];
...
export type LibraryKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'innovationHubs' | 'innovationPacks' | 'templates' | 'updatedDate' | 'virtualContributors' | LibraryKeySpecifier)[];
...
export type LicenseKeySpecifier = ('authorization' | 'availableEntitlements' | 'createdDate' | 'entitlements' | 'id' | 'type' | 'updatedDate' | LicenseKeySpecifier)[];
...
export type LicenseEntitlementKeySpecifier = ('createdDate' | 'dataType' | 'enabled' | 'id' | 'isAvailable' | 'limit' | 'type' | 'updatedDate' | 'usage' | LicenseEntitlementKeySpecifier)[];
...
export type LicensePlanKeySpecifier = ('assignToNewOrganizationAccounts' | 'assignToNewUserAccounts' | 'createdDate' | 'enabled' | 'id' | 'isFree' | 'licenseCredential' | 'name' | 'pricePerMonth' | 'requiresContactSupport' | 'requiresPaymentMethod' | 'sortOrder' | 'trialEnabled' | 'type' | 'updatedDate' | LicensePlanKeySpecifier)[];
...
export type LicensePolicyKeySpecifier = ('authorization' | 'createdDate' | 'credentialRules' | 'id' | 'updatedDate' | LicensePolicyKeySpecifier)[];
...
export type LicensingKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'plans' | 'policy' | 'updatedDate' | LicensingKeySpecifier)[];
...
export type LicensingCredentialBasedPolicyCredentialRuleKeySpecifier = ('credentialType' | 'grantedEntitlements' | 'id' | 'name' | LicensingCredentialBasedPolicyCredentialRuleKeySpecifier)[];
...
export type LinkKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'profile' | 'updatedDate' | 'uri' | LinkKeySpecifier)[];
...
export type LocationKeySpecifier = ('addressLine1' | 'addressLine2' | 'city' | 'country' | 'createdDate' | 'geoLocation' | 'id' | 'postalCode' | 'stateOrProvince' | 'updatedDate' | LocationKeySpecifier)[];
...
export type LookupByNameQueryResultsKeySpecifier = ('innovationHub' | 'innovationPack' | 'organization' | 'space' | 'template' | 'user' | 'virtualContributor' | LookupByNameQueryResultsKeySpecifier)[];
...
export type LookupMyPrivilegesQueryResultsKeySpecifier = ('account' | 'application' | 'calendar' | 'calendarEvent' | 'callout' | 'collaboration' | 'community' | 'communityGuidelines' | 'document' | 'innovationFlow' | 'innovationHub' | 'innovationPack' | 'invitation' | 'license' | 'post' | 'profile' | 'roleSet' | 'room' | 'space' | 'spaceAbout' | 'storageAggregator' | 'storageBucket' | 'template' | 'templatesManager' | 'templatesSet' | 'user' | 'virtualContributor' | 'whiteboard' | LookupMyPrivilegesQueryResultsKeySpecifier)[];
...
export type LookupQueryResultsKeySpecifier = ('about' | 'account' | 'application' | 'authorizationPolicy' | 'authorizationPrivilegesForUser' | 'calendar' | 'calendarEvent' | 'callout' | 'calloutsSet' | 'collaboration' | 'community' | 'communityGuidelines' | 'contribution' | 'conversation' | 'document' | 'innovationFlow' | 'innovationHub' | 'innovationPack' | 'invitation' | 'knowledgeBase' | 'license' | 'memo' | 'myPrivileges' | 'organization' | 'platformInvitation' | 'post' | 'profile' | 'roleSet' | 'room' | 'space' | 'storageAggregator' | 'storageBucket' | 'template' | 'templateContentSpace' | 'templatesManager' | 'templatesSet' | 'user' | 'virtualContributor' | 'whiteboard' | LookupQueryResultsKeySpecifier)[];
...
export type MeQueryResultsKeySpecifier = ('communityApplications' | 'communityInvitations' | 'communityInvitationsCount' | 'conversations' | 'id' | 'mySpaces' | 'notifications' | 'notificationsUnreadCount' | 'spaceMembershipsFlat' | 'spaceMembershipsHierarchical' | 'user' | MeQueryResultsKeySpecifier)[];
...
export type MediaGalleryKeySpecifier = ('authorization' | 'createdBy' | 'createdDate' | 'id' | 'storageBucket' | 'updatedDate' | 'visuals' | MediaGalleryKeySpecifier)[];
...
export type MemoKeySpecifier = ('authorization' | 'content' | 'contentUpdatePolicy' | 'createdBy' | 'createdDate' | 'id' | 'isMultiUser' | 'markdown' | 'nameID' | 'profile' | 'updatedDate' | MemoKeySpecifier)[];
...
export type MessageKeySpecifier = ('id' | 'message' | 'reactions' | 'sender' | 'threadID' | 'timestamp' | MessageKeySpecifier)[];
...
export type ModelCardAiEngineResultKeySpecifier = ('additionalTechnicalDetails' | 'areAnswersRestrictedToBodyOfKnowledge' | 'canAccessWebWhenAnswering' | 'hostingLocation' | 'isExternal' | 'isInteractionDataUsedForTraining' | 'isUsingOpenWeightsModel' | ModelCardAiEngineResultKeySpecifier)[];
...
export type ModelCardMonitoringResultKeySpecifier = ('isUsageMonitoredByAlkemio' | ModelCardMonitoringResultKeySpecifier)[];
export type ModelCardMonitoringResultFieldPolicy = {
	isUsageMonitoredByAlkemio?: FieldPolicy<any> | FieldReadFunction<any>
};
export type ModelCardSpaceUsageResultKeySpecifier = ('flags' | 'modelCardEntry' | ModelCardSpaceUsageResultKeySpecifier)[];
...
export type MutationKeySpecifier = ('addIframeAllowedURL' | 'addNotificationEmailToBlacklist' | 'addReactionToMessageInRoom' | 'addVisualToMediaGallery' | 'adminCommunicationEnsureAccessToCommunications' | 'adminCommunicationMigrateOrphanedConversations' | 'adminCommunicationRemoveOrphanedRoom' | 'adminCommunicationUpdateRoomState' | 'adminIdentityDeleteKratosIdentity' | 'adminInAppNotificationsPrune' | 'adminLicensePolicyCreateCredentialRule' | 'adminLicensePolicyDeleteCredentialRule' | 'adminLicensePolicyUpdateCredentialRule' | 'adminSearchIngestFromScratch' | 'adminUpdateContributorAvatars' | 'adminUpdateGeoLocationData' | 'adminUserAccountDelete' | 'adminWingbackCreateTestCustomer' | 'adminWingbackGetCustomerEntitlements' | 'aiServerAuthorizationPolicyReset' | 'aiServerCreateAiPersona' | 'aiServerDeleteAiPersona' | 'aiServerUpdateAiPersona' | 'applyForEntryRoleOnRoleSet' | 'assignConversationMember' | 'assignLicensePlanToAccount' | 'assignLicensePlanToSpace' | 'assignPlatformRoleToUser' | 'assignRole' | 'assignRoleToOrganization' | 'assignRoleToUser' | 'assignRoleToVirtualContributor' | 'assignUserToGroup' | 'authorizationPlatformRolesAccessReset' | 'authorizationPolicyResetAll' | 'authorizationPolicyResetOnAccount' | 'authorizationPolicyResetOnOrganization' | 'authorizationPolicyResetOnPlatform' | 'authorizationPolicyResetOnUser' | 'authorizationPolicyResetToGlobalAdminsAccess' | 'cleanupCollections' | 'convertSpaceL1ToSpaceL0' | 'convertSpaceL1ToSpaceL2' | 'convertSpaceL2ToSpaceL1' | 'convertVirtualContributorToUseKnowledgeBase' | 'createCalloutOnCalloutsSet' | 'createContributionOnCallout' | 'createConversation' | 'createDiscussion' | 'createEventOnCalendar' | 'createGroupOnCommunity' | 'createGroupOnOrganization' | 'createInnovationHub' | 'createInnovationPack' | 'createLicensePlan' | 'createOrganization' | 'createReferenceOnProfile' | 'createSpace' | 'createStateOnInnovationFlow' | 'createSubspace' | 'createTagsetOnProfile' | 'createTemplate' | 'createTemplateFromContentSpace' | 'createTemplateFromSpace' | 'createUser' | 'createVirtualContributor' | 'createWingbackAccount' | 'deleteApplication' | 'deleteCalendarEvent' | 'deleteCallout' | 'deleteContribution' | 'deleteConversation' | 'deleteDiscussion' | 'deleteDocument' | 'deleteInnovationHub' | 'deleteInnovationPack' | 'deleteInvitation' | 'deleteLicensePlan' | 'deleteLink' | 'deleteMemo' | 'deleteOrganization' | 'deletePlatformInvitation' | 'deletePost' | 'deleteReference' | 'deleteSpace' | 'deleteStateOnInnovationFlow' | 'deleteStorageBucket' | 'deleteTemplate' | 'deleteUser' | 'deleteUserGroup' | 'deleteVirtualContributor' | 'deleteVisualFromMediaGallery' | 'deleteWhiteboard' | 'eventOnApplication' | 'eventOnInvitation' | 'eventOnOrganizationVerification' | 'grantCredentialToActor' | 'grantCredentialToOrganization' | 'grantCredentialToUser' | 'inviteForEntryRoleOnRoleSet' | 'joinRoleSet' | 'leaveConversation' | 'licenseResetOnAccount' | 'markMessageAsReadInRoom' | 'markNotificationsAsRead' | 'markNotificationsAsUnread' | 'moveContributionToCallout' | 'refreshAllBodiesOfKnowledge' | 'refreshVirtualContributorBodyOfKnowledge' | 'removeCommunityGuidelinesContent' | 'removeConversationMember' | 'removeDefaultCalloutTemplateOnInnovationFlowState' | 'removeIframeAllowedURL' | 'removeMessageOnRoom' | 'removeNotificationEmailFromBlacklist' | 'removePlatformRoleFromUser' | 'removeReactionToMessageInRoom' | 'removeRole' | 'removeRoleFromOrganization' | 'removeRoleFromUser' | 'removeRoleFromVirtualContributor' | 'removeUserFromGroup' | 'resetConversationVc' | 'resetLicenseOnAccounts' | 'revokeCredentialFromActor' | 'revokeCredentialFromOrganization' | 'revokeCredentialFromUser' | 'revokeLicensePlanFromAccount' | 'revokeLicensePlanFromSpace' | 'sendMessageReplyToRoom' | 'sendMessageToCommunityLeads' | 'sendMessageToOrganization' | 'sendMessageToRoom' | 'sendMessageToUsers' | 'setDefaultCalloutTemplateOnInnovationFlowState' | 'setPlatformWellKnownVirtualContributor' | 'transferCallout' | 'transferInnovationHubToAccount' | 'transferInnovationPackToAccount' | 'transferSpaceToAccount' | 'transferVirtualContributorToAccount' | 'updateApplicationFormOnRoleSet' | 'updateBaselineLicensePlanOnAccount' | 'updateCalendarEvent' | 'updateCallout' | 'updateCalloutPublishInfo' | 'updateCalloutVisibility' | 'updateCalloutsSortOrder' | 'updateClassificationTagset' | 'updateCollaborationFromSpaceTemplate' | 'updateCommunityGuidelines' | 'updateContributionsSortOrder' | 'updateConversation' | 'updateDiscussion' | 'updateDocument' | 'updateInnovationFlow' | 'updateInnovationFlowCurrentState' | 'updateInnovationFlowState' | 'updateInnovationFlowStatesSortOrder' | 'updateInnovationHub' | 'updateInnovationPack' | 'updateLicensePlan' | 'updateLink' | 'updateMemo' | 'updateNotificationState' | 'updateOrganization' | 'updateOrganizationPlatformSettings' | 'updateOrganizationSettings' | 'updatePlatformSettings' | 'updatePost' | 'updateProfile' | 'updateReference' | 'updateSpace' | 'updateSpacePlatformSettings' | 'updateSpaceSettings' | 'updateSubspacePinned' | 'updateSubspacesSortOrder' | 'updateTagset' | 'updateTemplate' | 'updateTemplateContentSpace' | 'updateTemplateDefault' | 'updateTemplateFromSpace' | 'updateUser' | 'updateUserGroup' | 'updateUserPlatformSettings' | 'updateUserSettings' | 'updateVirtualContributor' | 'updateVirtualContributorPlatformSettings' | 'updateVirtualContributorSettings' | 'updateVisual' | 'updateWhiteboard' | 'updateWhiteboardGuestAccess' | 'uploadFileOnLink' | 'uploadFileOnReference' | 'uploadFileOnStorageBucket' | 'uploadImageOnVisual' | MutationKeySpecifier)[];
...
export type NotificationRecipientResultKeySpecifier = ('emailRecipients' | 'inAppRecipients' | 'triggeredBy' | NotificationRecipientResultKeySpecifier)[];
...
export type OrganizationKeySpecifier = ('account' | 'actor' | 'authorization' | 'contactEmail' | 'createdDate' | 'credentials' | 'domain' | 'group' | 'groups' | 'id' | 'legalEntityName' | 'metrics' | 'nameID' | 'profile' | 'roleSet' | 'settings' | 'storageAggregator' | 'type' | 'updatedDate' | 'verification' | 'website' | OrganizationKeySpecifier)[];
...
export type OrganizationSettingsMembershipKeySpecifier = ('allowUsersMatchingDomainToJoin' | OrganizationSettingsMembershipKeySpecifier)[];
...
export type OrganizationSettingsPrivacyKeySpecifier = ('contributionRolesPubliclyVisible' | OrganizationSettingsPrivacyKeySpecifier)[];
export type OrganizationSettingsPrivacyFieldPolicy = {
	contributionRolesPubliclyVisible?: FieldPolicy<any> | FieldReadFunction<any>
};
export type OrganizationVerificationKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'isFinalized' | 'lifecycle' | 'nextEvents' | 'state' | 'status' | 'updatedDate' | OrganizationVerificationKeySpecifier)[];
...
export type OrganizationsInRolesResponseKeySpecifier = ('organizations' | 'role' | OrganizationsInRolesResponseKeySpecifier)[];
...
export type PaginatedInAppNotificationsKeySpecifier = ('inAppNotifications' | 'pageInfo' | 'total' | PaginatedInAppNotificationsKeySpecifier)[];
export type PaginatedInAppNotificationsFieldPolicy = {
	inAppNotifications?: FieldPolicy<any> | FieldReadFunction<any>,
	pageInfo?: FieldPolicy<any> | FieldReadFunction<any>,
	total?: FieldPolicy<any> | FieldReadFunction<any>
};
export type PaginatedOrganizationKeySpecifier = ('organization' | 'pageInfo' | 'total' | PaginatedOrganizationKeySpecifier)[];
...
export type PaginatedVirtualContributorKeySpecifier = ('pageInfo' | 'total' | 'virtualContributors' | PaginatedVirtualContributorKeySpecifier)[];
export type PaginatedVirtualContributorFieldPolicy = {
	pageInfo?: FieldPolicy<any> | FieldReadFunction<any>,
	total?: FieldPolicy<any> | FieldReadFunction<any>,
	virtualContributors?: FieldPolicy<any> | FieldReadFunction<any>
};
export type PlatformKeySpecifier = ('authorization' | 'configuration' | 'createdDate' | 'forum' | 'id' | 'innovationHub' | 'latestReleaseDiscussion' | 'library' | 'licensingFramework' | 'messaging' | 'metadata' | 'roleSet' | 'settings' | 'storageAggregator' | 'templatesManager' | 'updatedDate' | 'wellKnownVirtualContributors' | PlatformKeySpecifier)[];
...
export type PlatformAdminCommunicationQueryResultsKeySpecifier = ('adminCommunicationMembership' | 'adminCommunicationOrphanedUsage' | PlatformAdminCommunicationQueryResultsKeySpecifier)[];
...
export type PlatformAdminIdentityQueryResultsKeySpecifier = ('identities' | PlatformAdminIdentityQueryResultsKeySpecifier)[];
export type PlatformAdminIdentityQueryResultsFieldPolicy = {
	identities?: FieldPolicy<any> | FieldReadFunction<any>
};
export type PlatformAdminQueryResultsKeySpecifier = ('communication' | 'identity' | 'innovationHubs' | 'innovationPacks' | 'organizations' | 'spaces' | 'users' | 'virtualContributors' | PlatformAdminQueryResultsKeySpecifier)[];
...
export type PlatformIntegrationSettingsKeySpecifier = ('iframeAllowedUrls' | 'notificationEmailBlacklist' | PlatformIntegrationSettingsKeySpecifier)[];
...
export type PlatformInvitationKeySpecifier = ('authorization' | 'createdBy' | 'createdDate' | 'email' | 'firstName' | 'id' | 'lastName' | 'platformRole' | 'profileCreated' | 'roleSetExtraRoles' | 'roleSetInvitedToParent' | 'updatedDate' | 'welcomeMessage' | PlatformInvitationKeySpecifier)[];
...
export type PlatformLocationsKeySpecifier = ('about' | 'aup' | 'blog' | 'community' | 'contactsupport' | 'documentation' | 'domain' | 'environment' | 'feedback' | 'forumreleases' | 'foundation' | 'help' | 'impact' | 'innovationLibrary' | 'inspiration' | 'landing' | 'newuser' | 'opensource' | 'privacy' | 'releases' | 'security' | 'support' | 'switchplan' | 'terms' | 'tips' | PlatformLocationsKeySpecifier)[];
...
export type PlatformWellKnownVirtualContributorMappingKeySpecifier = ('virtualContributorID' | 'wellKnown' | PlatformWellKnownVirtualContributorMappingKeySpecifier)[];
...
export type PlatformWellKnownVirtualContributorsKeySpecifier = ('mappings' | PlatformWellKnownVirtualContributorsKeySpecifier)[];
export type PlatformWellKnownVirtualContributorsFieldPolicy = {
	mappings?: FieldPolicy<any> | FieldReadFunction<any>
};
export type PostKeySpecifier = ('authorization' | 'comments' | 'createdBy' | 'createdDate' | 'id' | 'nameID' | 'profile' | 'updatedDate' | PostKeySpecifier)[];
...
export type ProfileKeySpecifier = ('authorization' | 'createdDate' | 'description' | 'displayName' | 'id' | 'location' | 'references' | 'storageBucket' | 'tagline' | 'tagset' | 'tagsets' | 'type' | 'updatedDate' | 'url' | 'visual' | 'visuals' | ProfileKeySpecifier)[];
...
export type PromptGraphDataPointKeySpecifier = ('description' | 'items' | 'name' | 'optional' | 'type' | PromptGraphDataPointKeySpecifier)[];
...
export type PromptGraphDefinitionKeySpecifier = ('edges' | 'end' | 'nodes' | 'start' | 'state' | PromptGraphDefinitionKeySpecifier)[];
...
export type PromptGraphDefinitionDataPointKeySpecifier = ('description' | 'name' | 'optional' | 'type' | PromptGraphDefinitionDataPointKeySpecifier)[];
...
export type PromptGraphDefinitionDataStructKeySpecifier = ('properties' | 'title' | 'type' | PromptGraphDefinitionDataStructKeySpecifier)[];
...
export type PromptGraphDefinitionNodeKeySpecifier = ('input_variables' | 'name' | 'output' | 'prompt' | 'system' | PromptGraphDefinitionNodeKeySpecifier)[];
...
export type PromptGraphNodeKeySpecifier = ('input_variables' | 'name' | 'output' | 'prompt' | 'system' | PromptGraphNodeKeySpecifier)[];
...
export type PruneInAppNotificationAdminResultKeySpecifier = ('removedCountExceedingUserLimit' | 'removedCountOutsideRetentionPeriod' | PruneInAppNotificationAdminResultKeySpecifier)[];
...
export type QueryKeySpecifier = ('accounts' | 'activityFeed' | 'activityFeedGrouped' | 'activityLogOnCollaboration' | 'actor' | 'actorsWithCredential' | 'adminIdentitiesUnverified' | 'aiServer' | 'exploreSpaces' | 'inputCreator' | 'lookup' | 'lookupByName' | 'me' | 'notificationRecipients' | 'organization' | 'organizations' | 'organizationsPaginated' | 'platform' | 'platformAdmin' | 'restrictedSpaceNames' | 'rolesOrganization' | 'rolesUser' | 'rolesVirtualContributor' | 'search' | 'spaces' | 'spacesPaginated' | 'task' | 'tasks' | 'urlResolver' | 'user' | 'users' | 'usersPaginated' | 'usersWithAuthorizationCredential' | 'virtualContributor' | 'virtualContributors' | QueryKeySpecifier)[];
...
export type ReferenceKeySpecifier = ('authorization' | 'createdDate' | 'description' | 'id' | 'name' | 'updatedDate' | 'uri' | ReferenceKeySpecifier)[];
...
export type RelayPaginatedSpaceKeySpecifier = ('about' | 'account' | 'activeSubscription' | 'actor' | 'authorization' | 'collaboration' | 'community' | 'createdDate' | 'credentials' | 'id' | 'level' | 'levelZeroSpaceID' | 'license' | 'nameID' | 'pinned' | 'platformAccess' | 'profile' | 'settings' | 'sortMode' | 'sortOrder' | 'storageAggregator' | 'subscriptions' | 'subspaceByNameID' | 'subspaces' | 'templatesManager' | 'type' | 'updatedDate' | 'visibility' | RelayPaginatedSpaceKeySpecifier)[];
...
export type RelayPaginatedSpacePageInfoKeySpecifier = ('endCursor' | 'hasNextPage' | 'hasPreviousPage' | 'startCursor' | RelayPaginatedSpacePageInfoKeySpecifier)[];
...
export type RoleKeySpecifier = ('createdDate' | 'credential' | 'id' | 'name' | 'organizationPolicy' | 'parentCredentials' | 'requiresEntryRole' | 'requiresSameRoleInParentRoleSet' | 'updatedDate' | 'userPolicy' | 'virtualContributorPolicy' | RoleKeySpecifier)[];
...
export type RoleSetKeySpecifier = ('applicationForm' | 'applications' | 'authorization' | 'availableUsersForElevatedRole' | 'availableUsersForEntryRole' | 'availableVirtualContributorsForEntryRole' | 'createdDate' | 'entryRoleName' | 'id' | 'invitations' | 'license' | 'myMembershipStatus' | 'myRoles' | 'myRolesImplicit' | 'organizationsInRole' | 'organizationsInRoles' | 'platformInvitations' | 'roleDefinition' | 'roleDefinitions' | 'roleNames' | 'type' | 'updatedDate' | 'usersInRole' | 'usersInRoles' | 'virtualContributorsInRole' | 'virtualContributorsInRoleInHierarchy' | 'virtualContributorsInRoles' | RoleSetKeySpecifier)[];
...
export type RoleSetInvitationResultKeySpecifier = ('invitation' | 'platformInvitation' | 'type' | RoleSetInvitationResultKeySpecifier)[];
...
export type RolesResultCommunityKeySpecifier = ('displayName' | 'id' | 'level' | 'nameID' | 'roles' | RolesResultCommunityKeySpecifier)[];
...
export type RolesResultOrganizationKeySpecifier = ('displayName' | 'id' | 'nameID' | 'organizationID' | 'roles' | 'userGroups' | RolesResultOrganizationKeySpecifier)[];
...
export type RolesResultSpaceKeySpecifier = ('displayName' | 'id' | 'level' | 'nameID' | 'roles' | 'spaceID' | 'subspaces' | 'visibility' | RolesResultSpaceKeySpecifier)[];
...
export type RoomKeySpecifier = ('authorization' | 'avatarUrl' | 'createdDate' | 'displayName' | 'id' | 'lastMessage' | 'messages' | 'messagesCount' | 'type' | 'unreadCount' | 'unreadCounts' | 'updatedDate' | 'vcInteractions' | RoomKeySpecifier)[];
...
export type RoomEventSubscriptionResultKeySpecifier = ('message' | 'reaction' | 'room' | 'roomID' | RoomEventSubscriptionResultKeySpecifier)[];
...
export type RoomMessageEventSubscriptionResultKeySpecifier = ('data' | 'type' | RoomMessageEventSubscriptionResultKeySpecifier)[];
export type RoomMessageEventSubscriptionResultFieldPolicy = {
	data?: FieldPolicy<any> | FieldReadFunction<any>,
	type?: FieldPolicy<any> | FieldReadFunction<any>
};
export type RoomMessageReactionEventSubscriptionResultKeySpecifier = ('data' | 'messageID' | 'type' | RoomMessageReactionEventSubscriptionResultKeySpecifier)[];
...
export type SearchResultCalloutKeySpecifier = ('callout' | 'id' | 'score' | 'space' | 'terms' | 'type' | SearchResultCalloutKeySpecifier)[];
...
export type SearchResultMemoKeySpecifier = ('callout' | 'id' | 'isContribution' | 'memo' | 'score' | 'space' | 'terms' | 'type' | SearchResultMemoKeySpecifier)[];
...
export type SearchResultOrganizationKeySpecifier = ('id' | 'organization' | 'score' | 'terms' | 'type' | SearchResultOrganizationKeySpecifier)[];
...
export type SearchResultPostKeySpecifier = ('callout' | 'id' | 'post' | 'score' | 'space' | 'terms' | 'type' | SearchResultPostKeySpecifier)[];
...
export type SearchResultSpaceKeySpecifier = ('id' | 'parentSpace' | 'score' | 'space' | 'terms' | 'type' | SearchResultSpaceKeySpecifier)[];
...
export type SearchResultUserKeySpecifier = ('id' | 'score' | 'terms' | 'type' | 'user' | SearchResultUserKeySpecifier)[];
...
export type SearchResultWhiteboardKeySpecifier = ('callout' | 'id' | 'isContribution' | 'score' | 'space' | 'terms' | 'type' | 'whiteboard' | SearchResultWhiteboardKeySpecifier)[];
...
export type SpaceKeySpecifier = ('about' | 'account' | 'activeSubscription' | 'actor' | 'authorization' | 'collaboration' | 'community' | 'createdDate' | 'credentials' | 'id' | 'level' | 'levelZeroSpaceID' | 'license' | 'nameID' | 'pinned' | 'platformAccess' | 'profile' | 'settings' | 'sortMode' | 'sortOrder' | 'storageAggregator' | 'subscriptions' | 'subspaceByNameID' | 'subspaces' | 'templatesManager' | 'type' | 'updatedDate' | 'visibility' | SpaceKeySpecifier)[];
...
export type SpaceAboutKeySpecifier = ('authorization' | 'createdDate' | 'guidelines' | 'id' | 'isContentPublic' | 'membership' | 'metrics' | 'profile' | 'provider' | 'updatedDate' | 'who' | 'why' | SpaceAboutKeySpecifier)[];
...
export type SpaceAboutMembershipKeySpecifier = ('applicationForm' | 'communityID' | 'leadOrganizations' | 'leadUsers' | 'myMembershipStatus' | 'myPrivileges' | 'roleSetID' | SpaceAboutMembershipKeySpecifier)[];
...
export type SpacePendingMembershipInfoKeySpecifier = ('about' | 'communityGuidelines' | 'id' | 'level' | SpacePendingMembershipInfoKeySpecifier)[];
...
export type SpaceSettingsKeySpecifier = ('collaboration' | 'membership' | 'privacy' | 'sortMode' | SpaceSettingsKeySpecifier)[];
...
export type SpaceSettingsCollaborationKeySpecifier = ('allowEventsFromSubspaces' | 'allowGuestContributions' | 'allowMembersToCreateCallouts' | 'allowMembersToCreateSubspaces' | 'allowMembersToVideoCall' | 'inheritMembershipRights' | SpaceSettingsCollaborationKeySpecifier)[];
...
export type SpaceSettingsMembershipKeySpecifier = ('allowSubspaceAdminsToInviteMembers' | 'policy' | 'trustedOrganizations' | SpaceSettingsMembershipKeySpecifier)[];
...
export type SpaceSettingsPrivacyKeySpecifier = ('allowPlatformSupportAsAdmin' | 'mode' | SpaceSettingsPrivacyKeySpecifier)[];
...
export type StorageAggregatorKeySpecifier = ('authorization' | 'createdDate' | 'directStorageBucket' | 'id' | 'parentEntity' | 'size' | 'storageAggregators' | 'storageBuckets' | 'type' | 'updatedDate' | StorageAggregatorKeySpecifier)[];
...
export type StorageAggregatorParentKeySpecifier = ('displayName' | 'id' | 'level' | 'url' | StorageAggregatorParentKeySpecifier)[];
...
export type StorageBucketKeySpecifier = ('allowedMimeTypes' | 'authorization' | 'createdDate' | 'document' | 'documents' | 'id' | 'maxFileSize' | 'parentEntity' | 'size' | 'updatedDate' | StorageBucketKeySpecifier)[];
...
export type StorageBucketParentKeySpecifier = ('displayName' | 'id' | 'type' | 'url' | StorageBucketParentKeySpecifier)[];
...
export type SubscriptionKeySpecifier = ('activityCreated' | 'calloutPostCreated' | 'conversationEvents' | 'forumDiscussionUpdated' | 'inAppNotificationReceived' | 'notificationsUnreadCount' | 'roomEvents' | 'subspaceCreated' | 'virtualContributorUpdated' | SubscriptionKeySpecifier)[];
...
export type TagsetKeySpecifier = ('allowedValues' | 'authorization' | 'createdDate' | 'id' | 'name' | 'tags' | 'type' | 'updatedDate' | TagsetKeySpecifier)[];
...
export type TagsetTemplateKeySpecifier = ('allowedValues' | 'createdDate' | 'defaultSelectedValue' | 'id' | 'name' | 'type' | 'updatedDate' | TagsetTemplateKeySpecifier)[];
...
export type TaskKeySpecifier = ('created' | 'end' | 'errors' | 'id' | 'itemsCount' | 'itemsDone' | 'progress' | 'results' | 'start' | 'status' | 'type' | TaskKeySpecifier)[];
...
export type TemplateKeySpecifier = ('authorization' | 'callout' | 'communityGuidelines' | 'contentSpace' | 'createdDate' | 'id' | 'nameID' | 'postDefaultDescription' | 'profile' | 'type' | 'updatedDate' | 'whiteboard' | TemplateKeySpecifier)[];
...
export type TemplateContentSpaceKeySpecifier = ('about' | 'authorization' | 'collaboration' | 'createdDate' | 'id' | 'level' | 'settings' | 'subspaces' | 'updatedDate' | TemplateContentSpaceKeySpecifier)[];
...
export type TemplateDefaultKeySpecifier = ('allowedTemplateType' | 'authorization' | 'createdDate' | 'id' | 'template' | 'type' | 'updatedDate' | TemplateDefaultKeySpecifier)[];
...
export type TemplatesManagerKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'templateDefaults' | 'templatesSet' | 'updatedDate' | TemplatesManagerKeySpecifier)[];
...
export type TemplatesSetKeySpecifier = ('authorization' | 'calloutTemplates' | 'calloutTemplatesCount' | 'communityGuidelinesTemplates' | 'communityGuidelinesTemplatesCount' | 'createdDate' | 'id' | 'postTemplates' | 'postTemplatesCount' | 'spaceTemplates' | 'spaceTemplatesCount' | 'templates' | 'templatesCount' | 'updatedDate' | 'whiteboardTemplates' | 'whiteboardTemplatesCount' | TemplatesSetKeySpecifier)[];
...
export type TimelineKeySpecifier = ('authorization' | 'calendar' | 'createdDate' | 'id' | 'updatedDate' | TimelineKeySpecifier)[];
...
export type UpdateWhiteboardGuestAccessResultKeySpecifier = ('success' | 'whiteboard' | UpdateWhiteboardGuestAccessResultKeySpecifier)[];
export type UpdateWhiteboardGuestAccessResultFieldPolicy = {
	success?: FieldPolicy<any> | FieldReadFunction<any>,
	whiteboard?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UrlResolverQueryClosestAncestorKeySpecifier = ('discussionId' | 'innovationHubId' | 'innovationPack' | 'organizationId' | 'space' | 'type' | 'url' | 'userId' | 'virtualContributor' | UrlResolverQueryClosestAncestorKeySpecifier)[];
...
export type UrlResolverQueryResultCalendarKeySpecifier = ('calendarEventId' | 'id' | UrlResolverQueryResultCalendarKeySpecifier)[];
export type UrlResolverQueryResultCalendarFieldPolicy = {
	calendarEventId?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UrlResolverQueryResultCalloutsSetKeySpecifier = ('calloutId' | 'contributionId' | 'id' | 'memoId' | 'postId' | 'type' | 'whiteboardId' | UrlResolverQueryResultCalloutsSetKeySpecifier)[];
...
export type UrlResolverQueryResultCollaborationKeySpecifier = ('calloutsSet' | 'id' | UrlResolverQueryResultCollaborationKeySpecifier)[];
export type UrlResolverQueryResultCollaborationFieldPolicy = {
	calloutsSet?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UrlResolverQueryResultInnovationPackKeySpecifier = ('id' | 'templatesSet' | UrlResolverQueryResultInnovationPackKeySpecifier)[];
export type UrlResolverQueryResultInnovationPackFieldPolicy = {
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	templatesSet?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UrlResolverQueryResultSpaceKeySpecifier = ('calendar' | 'collaboration' | 'id' | 'level' | 'levelZeroSpaceID' | 'parentSpaces' | 'templatesSet' | UrlResolverQueryResultSpaceKeySpecifier)[];
...
export type UrlResolverQueryResultTemplatesSetKeySpecifier = ('id' | 'templateId' | UrlResolverQueryResultTemplatesSetKeySpecifier)[];
export type UrlResolverQueryResultTemplatesSetFieldPolicy = {
	id?: FieldPolicy<any> | FieldReadFunction<any>,
	templateId?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UrlResolverQueryResultVirtualContributorKeySpecifier = ('calloutsSet' | 'id' | UrlResolverQueryResultVirtualContributorKeySpecifier)[];
export type UrlResolverQueryResultVirtualContributorFieldPolicy = {
	calloutsSet?: FieldPolicy<any> | FieldReadFunction<any>,
	id?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UrlResolverQueryResultsKeySpecifier = ('closestAncestor' | 'discussionId' | 'innovationHubId' | 'innovationPack' | 'organizationId' | 'space' | 'state' | 'type' | 'userId' | 'virtualContributor' | UrlResolverQueryResultsKeySpecifier)[];
...
export type UserKeySpecifier = ('account' | 'actor' | 'authentication' | 'authorization' | 'createdDate' | 'credentials' | 'email' | 'firstName' | 'id' | 'isContactable' | 'lastName' | 'nameID' | 'phone' | 'profile' | 'settings' | 'storageAggregator' | 'type' | 'updatedDate' | UserKeySpecifier)[];
...
export type UserAuthenticationResultKeySpecifier = ('authenticatedAt' | 'createdAt' | 'methods' | UserAuthenticationResultKeySpecifier)[];
...
export type UserGroupKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'members' | 'parent' | 'profile' | 'updatedDate' | UserGroupKeySpecifier)[];
...
export type UserSettingsKeySpecifier = ('authorization' | 'communication' | 'createdDate' | 'homeSpace' | 'id' | 'notification' | 'privacy' | 'updatedDate' | UserSettingsKeySpecifier)[];
...
export type UserSettingsCommunicationKeySpecifier = ('allowOtherUsersToSendMessages' | UserSettingsCommunicationKeySpecifier)[];
...
export type UserSettingsNotificationKeySpecifier = ('organization' | 'platform' | 'space' | 'user' | 'virtualContributor' | UserSettingsNotificationKeySpecifier)[];
...
export type UserSettingsNotificationChannelsKeySpecifier = ('email' | 'inApp' | UserSettingsNotificationChannelsKeySpecifier)[];
export type UserSettingsNotificationChannelsFieldPolicy = {
	email?: FieldPolicy<any> | FieldReadFunction<any>,
	inApp?: FieldPolicy<any> | FieldReadFunction<any>
};
export type UserSettingsNotificationOrganizationKeySpecifier = ('adminMentioned' | 'adminMessageReceived' | UserSettingsNotificationOrganizationKeySpecifier)[];
...
export type UserSettingsNotificationPlatformKeySpecifier = ('admin' | 'forumDiscussionComment' | 'forumDiscussionCreated' | UserSettingsNotificationPlatformKeySpecifier)[];
...
export type UserSettingsNotificationPlatformAdminKeySpecifier = ('spaceCreated' | 'userGlobalRoleChanged' | 'userProfileCreated' | 'userProfileRemoved' | UserSettingsNotificationPlatformAdminKeySpecifier)[];
...
export type UserSettingsNotificationSpaceKeySpecifier = ('admin' | 'collaborationCalloutComment' | 'collaborationCalloutContributionCreated' | 'collaborationCalloutPostContributionComment' | 'collaborationCalloutPublished' | 'communicationUpdates' | 'communityCalendarEvents' | UserSettingsNotificationSpaceKeySpecifier)[];
...
export type UserSettingsNotificationSpaceAdminKeySpecifier = ('collaborationCalloutContributionCreated' | 'communicationMessageReceived' | 'communityApplicationReceived' | 'communityNewMember' | UserSettingsNotificationSpaceAdminKeySpecifier)[];
...
export type UserSettingsNotificationUserKeySpecifier = ('commentReply' | 'membership' | 'mentioned' | 'messageReceived' | UserSettingsNotificationUserKeySpecifier)[];
...
export type UserSettingsNotificationUserMembershipKeySpecifier = ('spaceCommunityInvitationReceived' | 'spaceCommunityJoined' | UserSettingsNotificationUserMembershipKeySpecifier)[];
...
export type UserSettingsNotificationVirtualContributorKeySpecifier = ('adminSpaceCommunityInvitation' | UserSettingsNotificationVirtualContributorKeySpecifier)[];
...
export type VirtualContributorKeySpecifier = ('account' | 'actor' | 'aiPersona' | 'authorization' | 'bodyOfKnowledgeDescription' | 'bodyOfKnowledgeID' | 'bodyOfKnowledgeType' | 'createdDate' | 'credentials' | 'dataAccessMode' | 'engine' | 'id' | 'interactionModes' | 'knowledgeBase' | 'knowledgeSpace' | 'listedInStore' | 'modelCard' | 'nameID' | 'platformSettings' | 'profile' | 'promptGraphDefinition' | 'provider' | 'searchVisibility' | 'settings' | 'status' | 'type' | 'updatedDate' | 'wellKnownVirtualContributor' | VirtualContributorKeySpecifier)[];
...
export type VirtualContributorModelCardKeySpecifier = ('aiEngine' | 'monitoring' | 'spaceUsage' | VirtualContributorModelCardKeySpecifier)[];
...
export type VirtualContributorModelCardFlagKeySpecifier = ('enabled' | 'name' | VirtualContributorModelCardFlagKeySpecifier)[];
export type VirtualContributorModelCardFlagFieldPolicy = {
	enabled?: FieldPolicy<any> | FieldReadFunction<any>,
	name?: FieldPolicy<any> | FieldReadFunction<any>
};
export type VirtualContributorPlatformSettingsKeySpecifier = ('promptGraphEditingEnabled' | VirtualContributorPlatformSettingsKeySpecifier)[];
...
export type VirtualContributorSettingsPrivacyKeySpecifier = ('knowledgeBaseContentVisible' | VirtualContributorSettingsPrivacyKeySpecifier)[];
...
export type VirtualContributorUpdatedSubscriptionResultKeySpecifier = ('virtualContributor' | VirtualContributorUpdatedSubscriptionResultKeySpecifier)[];
export type VirtualContributorUpdatedSubscriptionResultFieldPolicy = {
	virtualContributor?: FieldPolicy<any> | FieldReadFunction<any>
};
export type VirtualContributorsInRolesResponseKeySpecifier = ('role' | 'virtualContributors' | VirtualContributorsInRolesResponseKeySpecifier)[];
export type VirtualContributorsInRolesResponseFieldPolicy = {
	role?: FieldPolicy<any> | FieldReadFunction<any>,
	virtualContributors?: FieldPolicy<any> | FieldReadFunction<any>
};
export type VisualKeySpecifier = ('allowedTypes' | 'alternativeText' | 'aspectRatio' | 'authorization' | 'createdDate' | 'id' | 'maxHeight' | 'maxWidth' | 'minHeight' | 'minWidth' | 'name' | 'sortOrder' | 'updatedDate' | 'uri' | VisualKeySpecifier)[];
...
export type VisualConstraintsKeySpecifier = ('allowedTypes' | 'aspectRatio' | 'maxHeight' | 'maxWidth' | 'minHeight' | 'minWidth' | VisualConstraintsKeySpecifier)[];
...
export type WhiteboardKeySpecifier = ('authorization' | 'content' | 'contentUpdatePolicy' | 'createdBy' | 'createdDate' | 'guestContributionsAllowed' | 'id' | 'isMultiUser' | 'nameID' | 'previewSettings' | 'profile' | 'updatedDate' | WhiteboardKeySpecifier)[];
...
export type WhiteboardPreviewCoordinatesKeySpecifier = ('height' | 'width' | 'x' | 'y' | WhiteboardPreviewCoordinatesKeySpecifier)[];
...
export type WhiteboardPreviewCoordinatesDataKeySpecifier = ('height' | 'width' | 'x' | 'y' | WhiteboardPreviewCoordinatesDataKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	ActivityCreatedSubscriptionResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityCreatedSubscriptionResultKeySpecifier | (() => undefined | ActivityCreatedSubscriptionResultKeySpecifier),
	...
	ActivityLogEntryCalendarEventCreated?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalendarEventCreatedKeySpecifier | (() => undefined | ActivityLogEntryCalendarEventCreatedKeySpecifier),
	...
	ActivityLogEntryCalloutDiscussionComment?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalloutDiscussionCommentKeySpecifier | (() => undefined | ActivityLogEntryCalloutDiscussionCommentKeySpecifier),
	...
	ActivityLogEntryCalloutLinkCreated?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalloutLinkCreatedKeySpecifier | (() => undefined | ActivityLogEntryCalloutLinkCreatedKeySpecifier),
		fields?: ActivityLogEntryCalloutLinkCreatedFieldPolicy,
	},
	ActivityLogEntryCalloutMemoCreated?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalloutMemoCreatedKeySpecifier | (() => undefined | ActivityLogEntryCalloutMemoCreatedKeySpecifier),
		fields?: ActivityLogEntryCalloutMemoCreatedFieldPolicy,
	},
	ActivityLogEntryCalloutPostComment?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalloutPostCommentKeySpecifier | (() => undefined | ActivityLogEntryCalloutPostCommentKeySpecifier),
		fields?: ActivityLogEntryCalloutPostCommentFieldPolicy,
	},
	ActivityLogEntryCalloutPostCreated?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalloutPostCreatedKeySpecifier | (() => undefined | ActivityLogEntryCalloutPostCreatedKeySpecifier),
		fields?: ActivityLogEntryCalloutPostCreatedFieldPolicy,
	},
	ActivityLogEntryCalloutPublished?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalloutPublishedKeySpecifier | (() => undefined | ActivityLogEntryCalloutPublishedKeySpecifier),
	...
	ActivityLogEntryCalloutWhiteboardContentModified?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalloutWhiteboardContentModifiedKeySpecifier | (() => undefined | ActivityLogEntryCalloutWhiteboardContentModifiedKeySpecifier),
	...
	ActivityLogEntryCalloutWhiteboardCreated?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryCalloutWhiteboardCreatedKeySpecifier | (() => undefined | ActivityLogEntryCalloutWhiteboardCreatedKeySpecifier),
		fields?: ActivityLogEntryCalloutWhiteboardCreatedFieldPolicy,
	},
	ActivityLogEntryMemberJoined?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryMemberJoinedKeySpecifier | (() => undefined | ActivityLogEntryMemberJoinedKeySpecifier),
		fields?: ActivityLogEntryMemberJoinedFieldPolicy,
	},
	ActivityLogEntrySubspaceCreated?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntrySubspaceCreatedKeySpecifier | (() => undefined | ActivityLogEntrySubspaceCreatedKeySpecifier),
		fields?: ActivityLogEntrySubspaceCreatedFieldPolicy,
	},
	ActivityLogEntryUpdateSent?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ActivityLogEntryUpdateSentKeySpecifier | (() => undefined | ActivityLogEntryUpdateSentKeySpecifier),
	...
	AuthenticationProviderConfig?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | AuthenticationProviderConfigKeySpecifier | (() => undefined | AuthenticationProviderConfigKeySpecifier),
	...
	AuthorizationPolicyRuleCredential?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | AuthorizationPolicyRuleCredentialKeySpecifier | (() => undefined | AuthorizationPolicyRuleCredentialKeySpecifier),
		fields?: AuthorizationPolicyRuleCredentialFieldPolicy,
	},
	AuthorizationPolicyRulePrivilege?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | AuthorizationPolicyRulePrivilegeKeySpecifier | (() => undefined | AuthorizationPolicyRulePrivilegeKeySpecifier),
	...
	CalloutContributionDefaults?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CalloutContributionDefaultsKeySpecifier | (() => undefined | CalloutContributionDefaultsKeySpecifier),
		fields?: CalloutContributionDefaultsFieldPolicy,
	},
	CalloutContributionsCountOutput?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CalloutContributionsCountOutputKeySpecifier | (() => undefined | CalloutContributionsCountOutputKeySpecifier),
	...
	CalloutSettingsContribution?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CalloutSettingsContributionKeySpecifier | (() => undefined | CalloutSettingsContributionKeySpecifier),
	...
	CommunicationAdminMembershipResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunicationAdminMembershipResultKeySpecifier | (() => undefined | CommunicationAdminMembershipResultKeySpecifier),
	...
	CommunicationAdminMigrateRoomsResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunicationAdminMigrateRoomsResultKeySpecifier | (() => undefined | CommunicationAdminMigrateRoomsResultKeySpecifier),
	...
	CommunicationAdminOrphanedUsageResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunicationAdminOrphanedUsageResultKeySpecifier | (() => undefined | CommunicationAdminOrphanedUsageResultKeySpecifier),
	...
	CommunicationAdminRoomMembershipResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunicationAdminRoomMembershipResultKeySpecifier | (() => undefined | CommunicationAdminRoomMembershipResultKeySpecifier),
		fields?: CommunicationAdminRoomMembershipResultFieldPolicy,
	},
	CommunicationAdminRoomResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunicationAdminRoomResultKeySpecifier | (() => undefined | CommunicationAdminRoomResultKeySpecifier),
	...
	CommunityApplicationForRoleResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunityApplicationForRoleResultKeySpecifier | (() => undefined | CommunityApplicationForRoleResultKeySpecifier),
		fields?: CommunityApplicationForRoleResultFieldPolicy,
	},
	CommunityApplicationResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunityApplicationResultKeySpecifier | (() => undefined | CommunityApplicationResultKeySpecifier),
	...
	CommunityInvitationForRoleResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunityInvitationForRoleResultKeySpecifier | (() => undefined | CommunityInvitationForRoleResultKeySpecifier),
		fields?: CommunityInvitationForRoleResultFieldPolicy,
	},
	CommunityInvitationResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunityInvitationResultKeySpecifier | (() => undefined | CommunityInvitationResultKeySpecifier),
		fields?: CommunityInvitationResultFieldPolicy,
	},
	CommunityMembershipResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CommunityMembershipResultKeySpecifier | (() => undefined | CommunityMembershipResultKeySpecifier),
	...
	ConversationEventSubscriptionResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ConversationEventSubscriptionResultKeySpecifier | (() => undefined | ConversationEventSubscriptionResultKeySpecifier),
		fields?: ConversationEventSubscriptionResultFieldPolicy,
	},
	ConversationMemberAddedEvent?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ConversationMemberAddedEventKeySpecifier | (() => undefined | ConversationMemberAddedEventKeySpecifier),
		fields?: ConversationMemberAddedEventFieldPolicy,
	},
	ConversationMemberRemovedEvent?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ConversationMemberRemovedEventKeySpecifier | (() => undefined | ConversationMemberRemovedEventKeySpecifier),
		fields?: ConversationMemberRemovedEventFieldPolicy,
	},
	ConversationMessageReceivedEvent?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ConversationMessageReceivedEventKeySpecifier | (() => undefined | ConversationMessageReceivedEventKeySpecifier),
		fields?: ConversationMessageReceivedEventFieldPolicy,
	},
	ConversationMessageRemovedEvent?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ConversationMessageRemovedEventKeySpecifier | (() => undefined | ConversationMessageRemovedEventKeySpecifier),
		fields?: ConversationMessageRemovedEventFieldPolicy,
	},
	ConversationReadReceiptUpdatedEvent?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ConversationReadReceiptUpdatedEventKeySpecifier | (() => undefined | ConversationReadReceiptUpdatedEventKeySpecifier),
	...
	CreateCalloutContributionData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateCalloutContributionDataKeySpecifier | (() => undefined | CreateCalloutContributionDataKeySpecifier),
		fields?: CreateCalloutContributionDataFieldPolicy,
	},
	CreateCalloutContributionDefaultsData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateCalloutContributionDefaultsDataKeySpecifier | (() => undefined | CreateCalloutContributionDefaultsDataKeySpecifier),
	...
	CreateCalloutSettingsContributionData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateCalloutSettingsContributionDataKeySpecifier | (() => undefined | CreateCalloutSettingsContributionDataKeySpecifier),
		fields?: CreateCalloutSettingsContributionDataFieldPolicy,
	},
	CreateCalloutSettingsData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateCalloutSettingsDataKeySpecifier | (() => undefined | CreateCalloutSettingsDataKeySpecifier),
		fields?: CreateCalloutSettingsDataFieldPolicy,
	},
	CreateCalloutSettingsFramingData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateCalloutSettingsFramingDataKeySpecifier | (() => undefined | CreateCalloutSettingsFramingDataKeySpecifier),
	...
	CreateCommunityGuidelinesData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateCommunityGuidelinesDataKeySpecifier | (() => undefined | CreateCommunityGuidelinesDataKeySpecifier),
	...
	CreateInnovationFlowStateData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateInnovationFlowStateDataKeySpecifier | (() => undefined | CreateInnovationFlowStateDataKeySpecifier),
		fields?: CreateInnovationFlowStateDataFieldPolicy,
	},
	CreateInnovationFlowStateSettingsData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateInnovationFlowStateSettingsDataKeySpecifier | (() => undefined | CreateInnovationFlowStateSettingsDataKeySpecifier),
	...
	CreateVisualOnProfileData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateVisualOnProfileDataKeySpecifier | (() => undefined | CreateVisualOnProfileDataKeySpecifier),
	...
	CreateWhiteboardPreviewSettingsData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | CreateWhiteboardPreviewSettingsDataKeySpecifier | (() => undefined | CreateWhiteboardPreviewSettingsDataKeySpecifier),
	...
	InAppNotificationPayloadOrganizationMessageDirect?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadOrganizationMessageDirectKeySpecifier | (() => undefined | InAppNotificationPayloadOrganizationMessageDirectKeySpecifier),
	...
	InAppNotificationPayloadOrganizationMessageRoom?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadOrganizationMessageRoomKeySpecifier | (() => undefined | InAppNotificationPayloadOrganizationMessageRoomKeySpecifier),
	...
	InAppNotificationPayloadPlatformForumDiscussion?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadPlatformForumDiscussionKeySpecifier | (() => undefined | InAppNotificationPayloadPlatformForumDiscussionKeySpecifier),
	...
	InAppNotificationPayloadPlatformGlobalRoleChange?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadPlatformGlobalRoleChangeKeySpecifier | (() => undefined | InAppNotificationPayloadPlatformGlobalRoleChangeKeySpecifier),
	...
	InAppNotificationPayloadPlatformUser?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadPlatformUserKeySpecifier | (() => undefined | InAppNotificationPayloadPlatformUserKeySpecifier),
	...
	InAppNotificationPayloadPlatformUserMessageRoom?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadPlatformUserMessageRoomKeySpecifier | (() => undefined | InAppNotificationPayloadPlatformUserMessageRoomKeySpecifier),
	...
	InAppNotificationPayloadPlatformUserProfileRemoved?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadPlatformUserProfileRemovedKeySpecifier | (() => undefined | InAppNotificationPayloadPlatformUserProfileRemovedKeySpecifier),
	...
	InAppNotificationPayloadSpace?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceKeySpecifier),
	...
	InAppNotificationPayloadSpaceCollaborationCallout?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCollaborationCalloutKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCollaborationCalloutKeySpecifier),
	...
	InAppNotificationPayloadSpaceCollaborationCalloutComment?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCollaborationCalloutCommentKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCollaborationCalloutCommentKeySpecifier),
	...
	InAppNotificationPayloadSpaceCollaborationCalloutPostComment?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCollaborationCalloutPostCommentKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCollaborationCalloutPostCommentKeySpecifier),
	...
	InAppNotificationPayloadSpaceCommunicationMessageDirect?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCommunicationMessageDirectKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCommunicationMessageDirectKeySpecifier),
	...
	InAppNotificationPayloadSpaceCommunicationUpdate?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCommunicationUpdateKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCommunicationUpdateKeySpecifier),
	...
	InAppNotificationPayloadSpaceCommunityActor?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCommunityActorKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCommunityActorKeySpecifier),
	...
	InAppNotificationPayloadSpaceCommunityApplication?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCommunityApplicationKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCommunityApplicationKeySpecifier),
	...
	InAppNotificationPayloadSpaceCommunityCalendarEvent?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCommunityCalendarEventKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCommunityCalendarEventKeySpecifier),
	...
	InAppNotificationPayloadSpaceCommunityCalendarEventComment?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCommunityCalendarEventCommentKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCommunityCalendarEventCommentKeySpecifier),
	...
	InAppNotificationPayloadSpaceCommunityInvitation?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCommunityInvitationKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCommunityInvitationKeySpecifier),
	...
	InAppNotificationPayloadSpaceCommunityInvitationPlatform?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadSpaceCommunityInvitationPlatformKeySpecifier | (() => undefined | InAppNotificationPayloadSpaceCommunityInvitationPlatformKeySpecifier),
	...
	InAppNotificationPayloadUserMessageDirect?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadUserMessageDirectKeySpecifier | (() => undefined | InAppNotificationPayloadUserMessageDirectKeySpecifier),
	...
	InAppNotificationPayloadVirtualContributor?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InAppNotificationPayloadVirtualContributorKeySpecifier | (() => undefined | InAppNotificationPayloadVirtualContributorKeySpecifier),
	...
	InnovationFlowStateSettings?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | InnovationFlowStateSettingsKeySpecifier | (() => undefined | InnovationFlowStateSettingsKeySpecifier),
	...
	LicensingCredentialBasedPolicyCredentialRule?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | LicensingCredentialBasedPolicyCredentialRuleKeySpecifier | (() => undefined | LicensingCredentialBasedPolicyCredentialRuleKeySpecifier),
	...
	LicensingGrantedEntitlement?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | LicensingGrantedEntitlementKeySpecifier | (() => undefined | LicensingGrantedEntitlementKeySpecifier),
	...
	LookupMyPrivilegesQueryResults?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | LookupMyPrivilegesQueryResultsKeySpecifier | (() => undefined | LookupMyPrivilegesQueryResultsKeySpecifier),
	...
	ModelCardMonitoringResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ModelCardMonitoringResultKeySpecifier | (() => undefined | ModelCardMonitoringResultKeySpecifier),
		fields?: ModelCardMonitoringResultFieldPolicy,
	},
	ModelCardSpaceUsageResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | ModelCardSpaceUsageResultKeySpecifier | (() => undefined | ModelCardSpaceUsageResultKeySpecifier),
	...
	NotificationRecipientResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | NotificationRecipientResultKeySpecifier | (() => undefined | NotificationRecipientResultKeySpecifier),
	...
	OrganizationSettingsMembership?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | OrganizationSettingsMembershipKeySpecifier | (() => undefined | OrganizationSettingsMembershipKeySpecifier),
		fields?: OrganizationSettingsMembershipFieldPolicy,
	},
	OrganizationSettingsPrivacy?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | OrganizationSettingsPrivacyKeySpecifier | (() => undefined | OrganizationSettingsPrivacyKeySpecifier),
	...
	OrganizationsInRolesResponse?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | OrganizationsInRolesResponseKeySpecifier | (() => undefined | OrganizationsInRolesResponseKeySpecifier),
	...
	PaginatedInAppNotifications?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PaginatedInAppNotificationsKeySpecifier | (() => undefined | PaginatedInAppNotificationsKeySpecifier),
	...
	PaginatedVirtualContributor?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PaginatedVirtualContributorKeySpecifier | (() => undefined | PaginatedVirtualContributorKeySpecifier),
	...
	PlatformAdminCommunicationQueryResults?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PlatformAdminCommunicationQueryResultsKeySpecifier | (() => undefined | PlatformAdminCommunicationQueryResultsKeySpecifier),
	...
	PlatformAdminIdentityQueryResults?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PlatformAdminIdentityQueryResultsKeySpecifier | (() => undefined | PlatformAdminIdentityQueryResultsKeySpecifier),
		fields?: PlatformAdminIdentityQueryResultsFieldPolicy,
	},
	PlatformAdminQueryResults?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PlatformAdminQueryResultsKeySpecifier | (() => undefined | PlatformAdminQueryResultsKeySpecifier),
	...
	PlatformIntegrationSettings?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PlatformIntegrationSettingsKeySpecifier | (() => undefined | PlatformIntegrationSettingsKeySpecifier),
	...
	PlatformWellKnownVirtualContributorMapping?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PlatformWellKnownVirtualContributorMappingKeySpecifier | (() => undefined | PlatformWellKnownVirtualContributorMappingKeySpecifier),
	...
	PlatformWellKnownVirtualContributors?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PlatformWellKnownVirtualContributorsKeySpecifier | (() => undefined | PlatformWellKnownVirtualContributorsKeySpecifier),
	...
	PromptGraphDefinitionDataPoint?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PromptGraphDefinitionDataPointKeySpecifier | (() => undefined | PromptGraphDefinitionDataPointKeySpecifier),
		fields?: PromptGraphDefinitionDataPointFieldPolicy,
	},
	PromptGraphDefinitionDataStruct?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PromptGraphDefinitionDataStructKeySpecifier | (() => undefined | PromptGraphDefinitionDataStructKeySpecifier),
		fields?: PromptGraphDefinitionDataStructFieldPolicy,
	},
	PromptGraphDefinitionEdge?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PromptGraphDefinitionEdgeKeySpecifier | (() => undefined | PromptGraphDefinitionEdgeKeySpecifier),
		fields?: PromptGraphDefinitionEdgeFieldPolicy,
	},
	PromptGraphDefinitionNode?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PromptGraphDefinitionNodeKeySpecifier | (() => undefined | PromptGraphDefinitionNodeKeySpecifier),
	...
	PruneInAppNotificationAdminResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | PruneInAppNotificationAdminResultKeySpecifier | (() => undefined | PruneInAppNotificationAdminResultKeySpecifier),
	...
	RelayPaginatedSpacePageInfo?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | RelayPaginatedSpacePageInfoKeySpecifier | (() => undefined | RelayPaginatedSpacePageInfoKeySpecifier),
	...
	RoomEventSubscriptionResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | RoomEventSubscriptionResultKeySpecifier | (() => undefined | RoomEventSubscriptionResultKeySpecifier),
		fields?: RoomEventSubscriptionResultFieldPolicy,
	},
	RoomMessageEventSubscriptionResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | RoomMessageEventSubscriptionResultKeySpecifier | (() => undefined | RoomMessageEventSubscriptionResultKeySpecifier),
	...
	RoomMessageReactionEventSubscriptionResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | RoomMessageReactionEventSubscriptionResultKeySpecifier | (() => undefined | RoomMessageReactionEventSubscriptionResultKeySpecifier),
	...
	SpacePendingMembershipInfo?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | SpacePendingMembershipInfoKeySpecifier | (() => undefined | SpacePendingMembershipInfoKeySpecifier),
	...
	SpaceSettingsCollaboration?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | SpaceSettingsCollaborationKeySpecifier | (() => undefined | SpaceSettingsCollaborationKeySpecifier),
	...
	StorageBucketUploadFileResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | StorageBucketUploadFileResultKeySpecifier | (() => undefined | StorageBucketUploadFileResultKeySpecifier),
	...
	UpdateWhiteboardGuestAccessResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UpdateWhiteboardGuestAccessResultKeySpecifier | (() => undefined | UpdateWhiteboardGuestAccessResultKeySpecifier),
		fields?: UpdateWhiteboardGuestAccessResultFieldPolicy,
	},
	UrlResolverQueryClosestAncestor?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UrlResolverQueryClosestAncestorKeySpecifier | (() => undefined | UrlResolverQueryClosestAncestorKeySpecifier),
		fields?: UrlResolverQueryClosestAncestorFieldPolicy,
	},
	UrlResolverQueryResultCalendar?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UrlResolverQueryResultCalendarKeySpecifier | (() => undefined | UrlResolverQueryResultCalendarKeySpecifier),
		fields?: UrlResolverQueryResultCalendarFieldPolicy,
	},
	UrlResolverQueryResultCalloutsSet?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UrlResolverQueryResultCalloutsSetKeySpecifier | (() => undefined | UrlResolverQueryResultCalloutsSetKeySpecifier),
		fields?: UrlResolverQueryResultCalloutsSetFieldPolicy,
	},
	UrlResolverQueryResultCollaboration?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UrlResolverQueryResultCollaborationKeySpecifier | (() => undefined | UrlResolverQueryResultCollaborationKeySpecifier),
	...
	UrlResolverQueryResultInnovationPack?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UrlResolverQueryResultInnovationPackKeySpecifier | (() => undefined | UrlResolverQueryResultInnovationPackKeySpecifier),
		fields?: UrlResolverQueryResultInnovationPackFieldPolicy,
	},
	UrlResolverQueryResultSpace?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UrlResolverQueryResultSpaceKeySpecifier | (() => undefined | UrlResolverQueryResultSpaceKeySpecifier),
		fields?: UrlResolverQueryResultSpaceFieldPolicy,
	},
	UrlResolverQueryResultTemplatesSet?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UrlResolverQueryResultTemplatesSetKeySpecifier | (() => undefined | UrlResolverQueryResultTemplatesSetKeySpecifier),
	...
	UrlResolverQueryResultVirtualContributor?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UrlResolverQueryResultVirtualContributorKeySpecifier | (() => undefined | UrlResolverQueryResultVirtualContributorKeySpecifier),
	...
	UserSettingsCommunication?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsCommunicationKeySpecifier | (() => undefined | UserSettingsCommunicationKeySpecifier),
	...
	UserSettingsNotificationChannels?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationChannelsKeySpecifier | (() => undefined | UserSettingsNotificationChannelsKeySpecifier),
		fields?: UserSettingsNotificationChannelsFieldPolicy,
	},
	UserSettingsNotificationOrganization?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationOrganizationKeySpecifier | (() => undefined | UserSettingsNotificationOrganizationKeySpecifier),
		fields?: UserSettingsNotificationOrganizationFieldPolicy,
	},
	UserSettingsNotificationPlatform?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationPlatformKeySpecifier | (() => undefined | UserSettingsNotificationPlatformKeySpecifier),
		fields?: UserSettingsNotificationPlatformFieldPolicy,
	},
	UserSettingsNotificationPlatformAdmin?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationPlatformAdminKeySpecifier | (() => undefined | UserSettingsNotificationPlatformAdminKeySpecifier),
		fields?: UserSettingsNotificationPlatformAdminFieldPolicy,
	},
	UserSettingsNotificationSpace?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationSpaceKeySpecifier | (() => undefined | UserSettingsNotificationSpaceKeySpecifier),
		fields?: UserSettingsNotificationSpaceFieldPolicy,
	},
	UserSettingsNotificationSpaceAdmin?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationSpaceAdminKeySpecifier | (() => undefined | UserSettingsNotificationSpaceAdminKeySpecifier),
		fields?: UserSettingsNotificationSpaceAdminFieldPolicy,
	},
	UserSettingsNotificationUser?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationUserKeySpecifier | (() => undefined | UserSettingsNotificationUserKeySpecifier),
		fields?: UserSettingsNotificationUserFieldPolicy,
	},
	UserSettingsNotificationUserMembership?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationUserMembershipKeySpecifier | (() => undefined | UserSettingsNotificationUserMembershipKeySpecifier),
	...
	UserSettingsNotificationVirtualContributor?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | UserSettingsNotificationVirtualContributorKeySpecifier | (() => undefined | UserSettingsNotificationVirtualContributorKeySpecifier),
	...
	VirtualContributorModelCard?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | VirtualContributorModelCardKeySpecifier | (() => undefined | VirtualContributorModelCardKeySpecifier),
		fields?: VirtualContributorModelCardFieldPolicy,
	},
	VirtualContributorModelCardFlag?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | VirtualContributorModelCardFlagKeySpecifier | (() => undefined | VirtualContributorModelCardFlagKeySpecifier),
		fields?: VirtualContributorModelCardFlagFieldPolicy,
	},
	VirtualContributorPlatformSettings?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | VirtualContributorPlatformSettingsKeySpecifier | (() => undefined | VirtualContributorPlatformSettingsKeySpecifier),
		fields?: VirtualContributorPlatformSettingsFieldPolicy,
	},
	VirtualContributorSettings?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | VirtualContributorSettingsKeySpecifier | (() => undefined | VirtualContributorSettingsKeySpecifier),
		fields?: VirtualContributorSettingsFieldPolicy,
	},
	VirtualContributorSettingsPrivacy?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | VirtualContributorSettingsPrivacyKeySpecifier | (() => undefined | VirtualContributorSettingsPrivacyKeySpecifier),
	...
	VirtualContributorUpdatedSubscriptionResult?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | VirtualContributorUpdatedSubscriptionResultKeySpecifier | (() => undefined | VirtualContributorUpdatedSubscriptionResultKeySpecifier),
	...
	VirtualContributorsInRolesResponse?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | VirtualContributorsInRolesResponseKeySpecifier | (() => undefined | VirtualContributorsInRolesResponseKeySpecifier),
	...
	WhiteboardPreviewCoordinates?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | WhiteboardPreviewCoordinatesKeySpecifier | (() => undefined | WhiteboardPreviewCoordinatesKeySpecifier),
		fields?: WhiteboardPreviewCoordinatesFieldPolicy,
	},
	WhiteboardPreviewCoordinatesData?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | WhiteboardPreviewCoordinatesDataKeySpecifier | (() => undefined | WhiteboardPreviewCoordinatesDataKeySpecifier),
		fields?: WhiteboardPreviewCoordinatesDataFieldPolicy,
	},
	WhiteboardPreviewSettings?: Omit<TypePolicy, "fields" | "keyFields"> & {
		keyFields?: false | WhiteboardPreviewSettingsKeySpecifier | (() => undefined | WhiteboardPreviewSettingsKeySpecifier),
