...
export type AccountKeySpecifier = ('agent' | 'authorization' | 'createdDate' | 'externalSubscriptionID' | 'host' | 'id' | 'innovationHubs' | 'innovationPacks' | 'license' | 'spaces' | 'storageAggregator' | 'subscriptions' | 'type' | 'updatedDate' | 'virtualContributors' | AccountKeySpecifier)[];
...
export type ActivityLogEntryMemberJoinedKeySpecifier = ('child' | 'collaborationID' | 'community' | 'contributor' | 'contributorType' | 'createdDate' | 'description' | 'id' | 'parentDisplayName' | 'space' | 'triggeredBy' | 'type' | ActivityLogEntryMemberJoinedKeySpecifier)[];
...
export type AgentKeySpecifier = ('authorization' | 'createdDate' | 'credentials' | 'did' | 'id' | 'type' | 'updatedDate' | 'verifiedCredentials' | AgentKeySpecifier)[];
...
export type AgentBeginVerifiedCredentialOfferOutputKeySpecifier = ('jwt' | 'qrCodeImg' | AgentBeginVerifiedCredentialOfferOutputKeySpecifier)[];
...
export type AgentBeginVerifiedCredentialRequestOutputKeySpecifier = ('jwt' | 'qrCodeImg' | AgentBeginVerifiedCredentialRequestOutputKeySpecifier)[];
export type AgentBeginVerifiedCredentialRequestOutputFieldPolicy = {
	jwt?: FieldPolicy<any> | FieldReadFunction<any>,
	qrCodeImg?: FieldPolicy<any> | FieldReadFunction<any>
};
export type AiPersonaKeySpecifier = ('aiPersonaServiceID' | 'authorization' | 'bodyOfKnowledge' | 'bodyOfKnowledgeID' | 'bodyOfKnowledgeType' | 'createdDate' | 'dataAccessMode' | 'description' | 'engine' | 'id' | 'interactionModes' | 'updatedDate' | AiPersonaKeySpecifier)[];
...
export type AiPersonaServiceKeySpecifier = ('authorization' | 'bodyOfKnowledgeID' | 'bodyOfKnowledgeLastUpdated' | 'bodyOfKnowledgeType' | 'createdDate' | 'dataAccessMode' | 'engine' | 'externalConfig' | 'id' | 'prompt' | 'updatedDate' | AiPersonaServiceKeySpecifier)[];
...
export type AiServerKeySpecifier = ('aiPersonaService' | 'aiPersonaServices' | 'authorization' | 'createdDate' | 'defaultAiPersonaService' | 'id' | 'updatedDate' | AiServerKeySpecifier)[];
...
export type ApplicationKeySpecifier = ('authorization' | 'contributor' | 'createdDate' | 'id' | 'isFinalized' | 'lifecycle' | 'nextEvents' | 'questions' | 'state' | 'updatedDate' | ApplicationKeySpecifier)[];
...
export type AuthorizationKeySpecifier = ('createdDate' | 'credentialRules' | 'id' | 'myPrivileges' | 'privilegeRules' | 'type' | 'updatedDate' | 'verifiedCredentialRules' | AuthorizationKeySpecifier)[];
...
export type AuthorizationPolicyRuleVerifiedCredentialKeySpecifier = ('claimRule' | 'credentialName' | 'grantedPrivileges' | AuthorizationPolicyRuleVerifiedCredentialKeySpecifier)[];
...
export type CalendarEventKeySpecifier = ('authorization' | 'comments' | 'createdBy' | 'createdDate' | 'durationDays' | 'durationMinutes' | 'id' | 'multipleDays' | 'nameID' | 'profile' | 'startDate' | 'subspace' | 'type' | 'updatedDate' | 'visibleOnParentCalendar' | 'wholeDay' | CalendarEventKeySpecifier)[];
...
export type CalloutKeySpecifier = ('activity' | 'authorization' | 'classification' | 'comments' | 'contributionDefaults' | 'contributionPolicy' | 'contributions' | 'createdBy' | 'createdDate' | 'framing' | 'id' | 'isTemplate' | 'nameID' | 'posts' | 'publishedBy' | 'publishedDate' | 'sortOrder' | 'type' | 'updatedDate' | 'visibility' | CalloutKeySpecifier)[];
...
export type CalloutContributionKeySpecifier = ('authorization' | 'createdBy' | 'createdDate' | 'id' | 'link' | 'post' | 'sortOrder' | 'updatedDate' | 'whiteboard' | CalloutContributionKeySpecifier)[];
...
export type CalloutContributionDefaultsKeySpecifier = ('createdDate' | 'id' | 'postDescription' | 'updatedDate' | 'whiteboardContent' | CalloutContributionDefaultsKeySpecifier)[];
...
export type CalloutContributionPolicyKeySpecifier = ('allowedContributionTypes' | 'createdDate' | 'id' | 'state' | 'updatedDate' | CalloutContributionPolicyKeySpecifier)[];
...
export type CalloutFramingKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'profile' | 'updatedDate' | 'whiteboard' | CalloutFramingKeySpecifier)[];
...
export type CalloutsSetKeySpecifier = ('authorization' | 'callouts' | 'createdDate' | 'id' | 'tagsetTemplates' | 'type' | 'updatedDate' | CalloutsSetKeySpecifier)[];
...
export type CommunityInvitationForRoleResultKeySpecifier = ('communityID' | 'contributorID' | 'contributorType' | 'createdBy' | 'createdDate' | 'displayName' | 'id' | 'spaceID' | 'spaceLevel' | 'state' | 'updatedDate' | 'welcomeMessage' | CommunityInvitationForRoleResultKeySpecifier)[];
...
export type ContributorKeySpecifier = ('agent' | 'authorization' | 'createdDate' | 'id' | 'nameID' | 'profile' | 'updatedDate' | ContributorKeySpecifier)[];
...
export type ContributorRolesKeySpecifier = ('applications' | 'id' | 'invitations' | 'organizations' | 'spaces' | ContributorRolesKeySpecifier)[];
...
export type CreateCalloutContributionDefaultsDataKeySpecifier = ('postDescription' | 'whiteboardContent' | CreateCalloutContributionDefaultsDataKeySpecifier)[];
export type CreateCalloutContributionDefaultsDataFieldPolicy = {
	postDescription?: FieldPolicy<any> | FieldReadFunction<any>,
	whiteboardContent?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CreateCalloutContributionPolicyDataKeySpecifier = ('state' | CreateCalloutContributionPolicyDataKeySpecifier)[];
export type CreateCalloutContributionPolicyDataFieldPolicy = {
	state?: FieldPolicy<any> | FieldReadFunction<any>
};
export type CreateCalloutDataKeySpecifier = ('classification' | 'contributionDefaults' | 'contributionPolicy' | 'enableComments' | 'framing' | 'nameID' | 'sendNotification' | 'sortOrder' | 'type' | 'visibility' | CreateCalloutDataKeySpecifier)[];
...
export type CreateCalloutFramingDataKeySpecifier = ('profile' | 'tags' | 'whiteboard' | CreateCalloutFramingDataKeySpecifier)[];
...
export type CreateInnovationFlowStateDataKeySpecifier = ('description' | 'displayName' | CreateInnovationFlowStateDataKeySpecifier)[];
...
export type CredentialMetadataOutputKeySpecifier = ('context' | 'description' | 'name' | 'schema' | 'types' | 'uniqueType' | CredentialMetadataOutputKeySpecifier)[];
...
export type ISearchResultsKeySpecifier = ('calloutResults' | 'contributionResults' | 'contributorResults' | 'spaceResults' | ISearchResultsKeySpecifier)[];
...
export type InAppNotificationKeySpecifier = ('category' | 'id' | 'receiver' | 'state' | 'triggeredAt' | 'triggeredBy' | 'type' | InAppNotificationKeySpecifier)[];
...
export type InAppNotificationCalloutPublishedKeySpecifier = ('callout' | 'category' | 'id' | 'receiver' | 'space' | 'state' | 'triggeredAt' | 'triggeredBy' | 'type' | InAppNotificationCalloutPublishedKeySpecifier)[];
...
export type InAppNotificationCommunityNewMemberKeySpecifier = ('actor' | 'category' | 'contributorType' | 'id' | 'receiver' | 'space' | 'state' | 'triggeredAt' | 'triggeredBy' | 'type' | InAppNotificationCommunityNewMemberKeySpecifier)[];
...
export type InAppNotificationUserMentionedKeySpecifier = ('category' | 'comment' | 'commentOriginName' | 'commentUrl' | 'contributorType' | 'id' | 'receiver' | 'state' | 'triggeredAt' | 'triggeredBy' | 'type' | InAppNotificationUserMentionedKeySpecifier)[];
...
export type InvitationKeySpecifier = ('authorization' | 'contributor' | 'contributorType' | 'createdBy' | 'createdDate' | 'extraRole' | 'id' | 'invitedToParent' | 'isFinalized' | 'lifecycle' | 'nextEvents' | 'state' | 'updatedDate' | 'welcomeMessage' | InvitationKeySpecifier)[];
...
export type LicensingCredentialBasedPolicyCredentialRuleKeySpecifier = ('credentialType' | 'grantedEntitlements' | 'name' | LicensingCredentialBasedPolicyCredentialRuleKeySpecifier)[];
...
export type LocationKeySpecifier = ('addressLine1' | 'addressLine2' | 'city' | 'country' | 'createdDate' | 'id' | 'postalCode' | 'stateOrProvince' | 'updatedDate' | LocationKeySpecifier)[];
...
export type MeQueryResultsKeySpecifier = ('communityApplications' | 'communityInvitations' | 'communityInvitationsCount' | 'id' | 'mySpaces' | 'spaceMembershipsFlat' | 'spaceMembershipsHierarchical' | 'user' | MeQueryResultsKeySpecifier)[];
...
export type MessageAnswerQuestionKeySpecifier = ('error' | 'id' | 'question' | 'success' | MessageAnswerQuestionKeySpecifier)[];
...
export type MutationKeySpecifier = ('addIframeAllowedURL' | 'addReactionToMessageInRoom' | 'adminCommunicationEnsureAccessToCommunications' | 'adminCommunicationRemoveOrphanedRoom' | 'adminCommunicationUpdateRoomState' | 'adminSearchIngestFromScratch' | 'adminUpdateContributorAvatars' | 'adminUserAccountDelete' | 'adminWingbackCreateTestCustomer' | 'adminWingbackGetCustomerEntitlements' | 'aiServerAuthorizationPolicyReset' | 'aiServerCreateAiPersonaService' | 'aiServerDeleteAiPersonaService' | 'aiServerUpdateAiPersonaService' | 'applyForEntryRoleOnRoleSet' | 'askChatGuidanceQuestion' | 'assignLicensePlanToAccount' | 'assignLicensePlanToSpace' | 'assignPlatformRoleToUser' | 'assignRoleToOrganization' | 'assignRoleToUser' | 'assignRoleToVirtualContributor' | 'assignUserToGroup' | 'authorizationPolicyResetAll' | 'authorizationPolicyResetOnAccount' | 'authorizationPolicyResetOnOrganization' | 'authorizationPolicyResetOnPlatform' | 'authorizationPolicyResetOnUser' | 'authorizationPolicyResetToGlobalAdminsAccess' | 'beginAlkemioUserVerifiedCredentialOfferInteraction' | 'beginCommunityMemberVerifiedCredentialOfferInteraction' | 'beginVerifiedCredentialRequestInteraction' | 'cleanupCollections' | 'convertSpaceL1ToSpaceL0' | 'convertSpaceL1ToSpaceL2' | 'convertSpaceL2ToSpaceL1' | 'convertVirtualContributorToUseKnowledgeBase' | 'createCalloutOnCalloutsSet' | 'createChatGuidanceRoom' | 'createContributionOnCallout' | 'createDiscussion' | 'createEventOnCalendar' | 'createGroupOnCommunity' | 'createGroupOnOrganization' | 'createInnovationHub' | 'createInnovationPack' | 'createLicensePlan' | 'createOrganization' | 'createReferenceOnProfile' | 'createSpace' | 'createSubspace' | 'createTagsetOnProfile' | 'createTemplate' | 'createTemplateFromCollaboration' | 'createUser' | 'createUserNewRegistration' | 'createVirtualContributor' | 'createWingbackAccount' | 'deleteCalendarEvent' | 'deleteCallout' | 'deleteDiscussion' | 'deleteDocument' | 'deleteInnovationHub' | 'deleteInnovationPack' | 'deleteInvitation' | 'deleteLicensePlan' | 'deleteLink' | 'deleteOrganization' | 'deletePlatformInvitation' | 'deletePost' | 'deleteReference' | 'deleteSpace' | 'deleteStorageBucket' | 'deleteTemplate' | 'deleteUser' | 'deleteUserApplication' | 'deleteUserGroup' | 'deleteVirtualContributor' | 'deleteWhiteboard' | 'eventOnApplication' | 'eventOnInvitation' | 'eventOnOrganizationVerification' | 'grantCredentialToOrganization' | 'grantCredentialToUser' | 'inviteForEntryRoleOnRoleSet' | 'joinRoleSet' | 'licenseResetOnAccount' | 'markNotificationsAsRead' | 'markNotificationsAsUnread' | 'messageUser' | 'moveContributionToCallout' | 'refreshAllBodiesOfKnowledge' | 'refreshVirtualContributorBodyOfKnowledge' | 'removeCommunityGuidelinesContent' | 'removeIframeAllowedURL' | 'removeMessageOnRoom' | 'removePlatformRoleFromUser' | 'removeReactionToMessageInRoom' | 'removeRoleFromOrganization' | 'removeRoleFromUser' | 'removeRoleFromVirtualContributor' | 'removeUserFromGroup' | 'resetChatGuidance' | 'resetLicenseOnAccounts' | 'revokeCredentialFromOrganization' | 'revokeCredentialFromUser' | 'revokeLicensePlanFromAccount' | 'revokeLicensePlanFromSpace' | 'sendMessageReplyToRoom' | 'sendMessageToCommunityLeads' | 'sendMessageToOrganization' | 'sendMessageToRoom' | 'sendMessageToUser' | 'transferCallout' | 'transferInnovationHubToAccount' | 'transferInnovationPackToAccount' | 'transferSpaceToAccount' | 'transferVirtualContributorToAccount' | 'updateAiPersona' | 'updateAnswerRelevance' | 'updateApplicationFormOnRoleSet' | 'updateCalendarEvent' | 'updateCallout' | 'updateCalloutPublishInfo' | 'updateCalloutVisibility' | 'updateCalloutsSortOrder' | 'updateClassificationTagset' | 'updateCollaborationFromTemplate' | 'updateCommunityGuidelines' | 'updateContributionsSortOrder' | 'updateDiscussion' | 'updateDocument' | 'updateInnovationFlow' | 'updateInnovationFlowSelectedState' | 'updateInnovationFlowSingleState' | 'updateInnovationHub' | 'updateInnovationPack' | 'updateLicensePlan' | 'updateLink' | 'updateNotificationState' | 'updateOrganization' | 'updateOrganizationPlatformSettings' | 'updateOrganizationSettings' | 'updatePlatformSettings' | 'updatePost' | 'updatePreferenceOnUser' | 'updateProfile' | 'updateReference' | 'updateSpace' | 'updateSpacePlatformSettings' | 'updateSpaceSettings' | 'updateTagset' | 'updateTemplate' | 'updateTemplateDefault' | 'updateTemplateFromCollaboration' | 'updateUser' | 'updateUserGroup' | 'updateUserPlatformSettings' | 'updateUserSettings' | 'updateVirtualContributor' | 'updateVirtualContributorSettings' | 'updateVisual' | 'updateWhiteboard' | 'uploadFileOnLink' | 'uploadFileOnReference' | 'uploadFileOnStorageBucket' | 'uploadImageOnVisual' | MutationKeySpecifier)[];
...
export type OrganizationKeySpecifier = ('account' | 'agent' | 'authorization' | 'contactEmail' | 'createdDate' | 'domain' | 'group' | 'groups' | 'id' | 'legalEntityName' | 'metrics' | 'nameID' | 'profile' | 'roleSet' | 'settings' | 'storageAggregator' | 'updatedDate' | 'verification' | 'website' | OrganizationKeySpecifier)[];
...
export type PlatformKeySpecifier = ('authorization' | 'chatGuidanceVirtualContributor' | 'configuration' | 'createdDate' | 'forum' | 'id' | 'innovationHub' | 'latestReleaseDiscussion' | 'library' | 'licensingFramework' | 'metadata' | 'roleSet' | 'settings' | 'storageAggregator' | 'templatesManager' | 'updatedDate' | PlatformKeySpecifier)[];
...
export type PlatformInvitationKeySpecifier = ('authorization' | 'createdBy' | 'createdDate' | 'email' | 'firstName' | 'id' | 'lastName' | 'platformRole' | 'profileCreated' | 'roleSetExtraRole' | 'roleSetInvitedToParent' | 'updatedDate' | 'welcomeMessage' | PlatformInvitationKeySpecifier)[];
...
export type PreferenceKeySpecifier = ('authorization' | 'createdDate' | 'definition' | 'id' | 'updatedDate' | 'value' | PreferenceKeySpecifier)[];
...
export type PreferenceDefinitionKeySpecifier = ('createdDate' | 'description' | 'displayName' | 'group' | 'id' | 'type' | 'updatedDate' | 'valueType' | PreferenceDefinitionKeySpecifier)[];
...
export type QueryKeySpecifier = ('accounts' | 'activityFeed' | 'activityFeedGrouped' | 'activityLogOnCollaboration' | 'adminCommunicationMembership' | 'adminCommunicationOrphanedUsage' | 'aiServer' | 'exploreSpaces' | 'getSupportedVerifiedCredentialMetadata' | 'inputCreator' | 'lookup' | 'lookupByName' | 'me' | 'notifications' | 'organization' | 'organizations' | 'organizationsPaginated' | 'platform' | 'rolesOrganization' | 'rolesUser' | 'rolesVirtualContributor' | 'search' | 'spaces' | 'spacesPaginated' | 'task' | 'tasks' | 'urlResolver' | 'user' | 'userAuthorizationPrivileges' | 'users' | 'usersPaginated' | 'usersWithAuthorizationCredential' | 'virtualContributor' | 'virtualContributors' | QueryKeySpecifier)[];
...
export type RelayPaginatedSpaceKeySpecifier = ('about' | 'account' | 'activeSubscription' | 'agent' | 'authorization' | 'collaboration' | 'community' | 'createdDate' | 'id' | 'level' | 'levelZeroSpaceID' | 'license' | 'nameID' | 'settings' | 'storageAggregator' | 'subscriptions' | 'subspaceByNameID' | 'subspaces' | 'templatesManager' | 'updatedDate' | 'visibility' | RelayPaginatedSpaceKeySpecifier)[];
...
export type RoleSetKeySpecifier = ('applicationForm' | 'applications' | 'authorization' | 'availableUsersForElevatedRole' | 'availableUsersForEntryRole' | 'createdDate' | 'entryRoleName' | 'id' | 'invitations' | 'license' | 'myMembershipStatus' | 'myRoles' | 'myRolesImplicit' | 'organizationsInRole' | 'organizationsInRoles' | 'platformInvitations' | 'roleDefinition' | 'roleDefinitions' | 'roleNames' | 'type' | 'updatedDate' | 'usersInRole' | 'usersInRoles' | 'virtualContributorsInRole' | 'virtualContributorsInRoles' | RoleSetKeySpecifier)[];
...
export type RoomKeySpecifier = ('authorization' | 'createdDate' | 'id' | 'messages' | 'messagesCount' | 'updatedDate' | 'vcInteractions' | RoomKeySpecifier)[];
...
export type SpaceKeySpecifier = ('about' | 'account' | 'activeSubscription' | 'agent' | 'authorization' | 'collaboration' | 'community' | 'createdDate' | 'id' | 'level' | 'levelZeroSpaceID' | 'license' | 'nameID' | 'settings' | 'storageAggregator' | 'subscriptions' | 'subspaceByNameID' | 'subspaces' | 'templatesManager' | 'updatedDate' | 'visibility' | SpaceKeySpecifier)[];
...
export type SpaceSettingsCollaborationKeySpecifier = ('allowEventsFromSubspaces' | 'allowMembersToCreateCallouts' | 'allowMembersToCreateSubspaces' | 'inheritMembershipRights' | SpaceSettingsCollaborationKeySpecifier)[];
...
export type SubscriptionKeySpecifier = ('activityCreated' | 'calloutPostCreated' | 'forumDiscussionUpdated' | 'inAppNotificationReceived' | 'profileVerifiedCredential' | 'roomEvents' | 'subspaceCreated' | 'virtualContributorUpdated' | SubscriptionKeySpecifier)[];
...
export type TemplateKeySpecifier = ('authorization' | 'callout' | 'collaboration' | 'communityGuidelines' | 'createdDate' | 'id' | 'nameID' | 'postDefaultDescription' | 'profile' | 'type' | 'updatedDate' | 'whiteboard' | TemplateKeySpecifier)[];
...
export type TemplatesSetKeySpecifier = ('authorization' | 'calloutTemplates' | 'calloutTemplatesCount' | 'collaborationTemplates' | 'collaborationTemplatesCount' | 'communityGuidelinesTemplates' | 'communityGuidelinesTemplatesCount' | 'createdDate' | 'id' | 'postTemplates' | 'postTemplatesCount' | 'templates' | 'templatesCount' | 'updatedDate' | 'whiteboardTemplates' | 'whiteboardTemplatesCount' | TemplatesSetKeySpecifier)[];
...
export type UrlResolverQueryResultCalloutsSetKeySpecifier = ('calloutId' | 'contributionId' | 'id' | 'postId' | 'type' | 'whiteboardId' | UrlResolverQueryResultCalloutsSetKeySpecifier)[];
...
export type UrlResolverQueryResultsKeySpecifier = ('discussionId' | 'innovationHubId' | 'innovationPack' | 'organizationId' | 'space' | 'type' | 'userId' | 'virtualContributor' | UrlResolverQueryResultsKeySpecifier)[];
...
export type UserKeySpecifier = ('account' | 'accountUpn' | 'agent' | 'authentication' | 'authorization' | 'communityRooms' | 'createdDate' | 'directRooms' | 'email' | 'firstName' | 'guidanceRoom' | 'id' | 'isContactable' | 'lastName' | 'nameID' | 'phone' | 'preferences' | 'profile' | 'settings' | 'storageAggregator' | 'updatedDate' | UserKeySpecifier)[];
...
export type UserAuthenticationResultKeySpecifier = ('authenticatedAt' | 'createdAt' | 'method' | UserAuthenticationResultKeySpecifier)[];
...
export type VcInteractionKeySpecifier = ('createdDate' | 'id' | 'room' | 'threadID' | 'updatedDate' | 'virtualContributorID' | VcInteractionKeySpecifier)[];
...
export type VerifiedCredentialKeySpecifier = ('claims' | 'context' | 'expires' | 'issued' | 'issuer' | 'name' | 'type' | VerifiedCredentialKeySpecifier)[];
...
export type VirtualContributorKeySpecifier = ('account' | 'agent' | 'aiPersona' | 'authorization' | 'createdDate' | 'id' | 'knowledgeBase' | 'listedInStore' | 'nameID' | 'profile' | 'provider' | 'searchVisibility' | 'settings' | 'status' | 'updatedDate' | VirtualContributorKeySpecifier)[];
...
export type VisualKeySpecifier = ('allowedTypes' | 'alternativeText' | 'aspectRatio' | 'authorization' | 'createdDate' | 'id' | 'maxHeight' | 'maxWidth' | 'minHeight' | 'minWidth' | 'name' | 'updatedDate' | 'uri' | VisualKeySpecifier)[];
...
export type WhiteboardKeySpecifier = ('authorization' | 'content' | 'contentUpdatePolicy' | 'createdBy' | 'createdDate' | 'id' | 'isMultiUser' | 'nameID' | 'profile' | 'updatedDate' | WhiteboardKeySpecifier)[];
...
export type StrictTypedTypePolicies = {
	...
	AgentBeginVerifiedCredentialOfferOutput?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | AgentBeginVerifiedCredentialOfferOutputKeySpecifier | (() => undefined | AgentBeginVerifiedCredentialOfferOutputKeySpecifier),
	...
	AgentBeginVerifiedCredentialRequestOutput?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | AgentBeginVerifiedCredentialRequestOutputKeySpecifier | (() => undefined | AgentBeginVerifiedCredentialRequestOutputKeySpecifier),
	...
	AuthorizationPolicyRuleVerifiedCredential?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | AuthorizationPolicyRuleVerifiedCredentialKeySpecifier | (() => undefined | AuthorizationPolicyRuleVerifiedCredentialKeySpecifier),
	...
	CalloutContributionPolicy?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | CalloutContributionPolicyKeySpecifier | (() => undefined | CalloutContributionPolicyKeySpecifier),
	...
	CreateCalloutContributionPolicyData?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | CreateCalloutContributionPolicyDataKeySpecifier | (() => undefined | CreateCalloutContributionPolicyDataKeySpecifier),
	...
	InAppNotificationCalloutPublished?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | InAppNotificationCalloutPublishedKeySpecifier | (() => undefined | InAppNotificationCalloutPublishedKeySpecifier),
		fields?: InAppNotificationCalloutPublishedFieldPolicy,
	},
	InAppNotificationCommunityNewMember?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | InAppNotificationCommunityNewMemberKeySpecifier | (() => undefined | InAppNotificationCommunityNewMemberKeySpecifier),
		fields?: InAppNotificationCommunityNewMemberFieldPolicy,
	},
	InAppNotificationUserMentioned?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | InAppNotificationUserMentionedKeySpecifier | (() => undefined | InAppNotificationUserMentionedKeySpecifier),
	...
	ProfileCredentialVerified?: Omit<TypePolicy, 'fields' | 'keyFields'> & {
		keyFields?: false | ProfileCredentialVerifiedKeySpecifier | (() => undefined | ProfileCredentialVerifiedKeySpecifier),
