...
export const CalloutTemplateFramingDefaultContributionsDocument = gql`
  query CalloutTemplateFramingDefaultContributions($templateId: UUID!) {
    lookup {
...
/**
 * __useCalloutTemplateFramingDefaultContributionsQuery__
 *
 * To run a query within a React component, call `useCalloutTemplateFramingDefaultContributionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useCalloutTemplateFramingDefaultContributionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCalloutTemplateFramingDefaultContributionsQuery({
 *   variables: {
 *      templateId: // value for 'templateId'
 *   },
 * });
 */
export function useCalloutTemplateFramingDefaultContributionsQuery(
  baseOptions: Apollo.QueryHookOptions<
    SchemaTypes.CalloutTemplateFramingDefaultContributionsQuery,
    SchemaTypes.CalloutTemplateFramingDefaultContributionsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    SchemaTypes.CalloutTemplateFramingDefaultContributionsQuery,
    SchemaTypes.CalloutTemplateFramingDefaultContributionsQueryVariables
  >(CalloutTemplateFramingDefaultContributionsDocument, options);
}

export function useCalloutTemplateFramingDefaultContributionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SchemaTypes.CalloutTemplateFramingDefaultContributionsQuery,
    SchemaTypes.CalloutTemplateFramingDefaultContributionsQueryVariables
  >
...
export type CalloutTemplateFramingDefaultContributionsQueryHookResult = ReturnType<
  typeof useCalloutTemplateFramingDefaultContributionsQuery
>;
export type CalloutTemplateFramingDefaultContributionsLazyQueryHookResult = ReturnType<
  typeof useCalloutTemplateFramingDefaultContributionsLazyQuery
>;
export type CalloutTemplateFramingDefaultContributionsQueryResult = Apollo.QueryResult<
  SchemaTypes.CalloutTemplateFramingDefaultContributionsQuery,
  SchemaTypes.CalloutTemplateFramingDefaultContributionsQueryVariables
>;
export function refetchCalloutTemplateFramingDefaultContributionsQuery(
  variables: SchemaTypes.CalloutTemplateFramingDefaultContributionsQueryVariables
) {
  return { query: CalloutTemplateFramingDefaultContributionsDocument, variables: variables };
}
