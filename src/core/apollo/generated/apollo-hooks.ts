...
export const SpacePriviledgesDocument = gql`
  query SpacePriviledges($spaceNameId: UUID_NAMEID!) {
    space(ID: $spaceNameId) {
      id
      authorization {
        myPrivileges
...
/**
 * __useSpacePriviledgesQuery__
 *
 * To run a query within a React component, call `useSpacePriviledgesQuery` and pass it any options that fit your needs.
 * When your component renders, `useSpacePriviledgesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSpacePriviledgesQuery({
 *   variables: {
 *      spaceNameId: // value for 'spaceNameId'
 *   },
 * });
 */
export function useSpacePriviledgesQuery(
  baseOptions: Apollo.QueryHookOptions<SchemaTypes.SpacePriviledgesQuery, SchemaTypes.SpacePriviledgesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SchemaTypes.SpacePriviledgesQuery, SchemaTypes.SpacePriviledgesQueryVariables>(
    SpacePriviledgesDocument,
    options
  );
}

export function useSpacePriviledgesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SchemaTypes.SpacePriviledgesQuery,
    SchemaTypes.SpacePriviledgesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SchemaTypes.SpacePriviledgesQuery, SchemaTypes.SpacePriviledgesQueryVariables>(
    SpacePriviledgesDocument,
    options
  );
}

export type SpacePriviledgesQueryHookResult = ReturnType<typeof useSpacePriviledgesQuery>;
export type SpacePriviledgesLazyQueryHookResult = ReturnType<typeof useSpacePriviledgesLazyQuery>;
export type SpacePriviledgesQueryResult = Apollo.QueryResult<
  SchemaTypes.SpacePriviledgesQuery,
  SchemaTypes.SpacePriviledgesQueryVariables
>;
export function refetchSpacePriviledgesQuery(variables: SchemaTypes.SpacePriviledgesQueryVariables) {
  return { query: SpacePriviledgesDocument, variables: variables };
}

export const SubspacePriviledgesDocument = gql`
  query SubspacePriviledges($subspaceId: UUID!) {
    lookup {
      space(ID: $subspaceId) {
        id
        authorization {
...
/**
 * __useSubspacePriviledgesQuery__
 *
 * To run a query within a React component, call `useSubspacePriviledgesQuery` and pass it any options that fit your needs.
 * When your component renders, `useSubspacePriviledgesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSubspacePriviledgesQuery({
 *   variables: {
 *      subspaceId: // value for 'subspaceId'
 *   },
 * });
 */
export function useSubspacePriviledgesQuery(
  baseOptions: Apollo.QueryHookOptions<
    SchemaTypes.SubspacePriviledgesQuery,
    SchemaTypes.SubspacePriviledgesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SchemaTypes.SubspacePriviledgesQuery, SchemaTypes.SubspacePriviledgesQueryVariables>(
    SubspacePriviledgesDocument,
    options
  );
}

export function useSubspacePriviledgesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SchemaTypes.SubspacePriviledgesQuery,
    SchemaTypes.SubspacePriviledgesQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SchemaTypes.SubspacePriviledgesQuery, SchemaTypes.SubspacePriviledgesQueryVariables>(
    SubspacePriviledgesDocument,
    options
  );
}

export type SubspacePriviledgesQueryHookResult = ReturnType<typeof useSubspacePriviledgesQuery>;
export type SubspacePriviledgesLazyQueryHookResult = ReturnType<typeof useSubspacePriviledgesLazyQuery>;
export type SubspacePriviledgesQueryResult = Apollo.QueryResult<
  SchemaTypes.SubspacePriviledgesQuery,
  SchemaTypes.SubspacePriviledgesQueryVariables
>;
export function refetchSubspacePriviledgesQuery(variables: SchemaTypes.SubspacePriviledgesQueryVariables) {
  return { query: SubspacePriviledgesDocument, variables: variables };
}
