...
export type Callout = {
  ...
  /** The comments associated with this Callout. */
  comments?: Maybe<Room>;
...
export type Discussion = {
  ...
  category: DiscussionCategory;
  /** The comment in this Discussion. */
  comments: Room;
...
export type ActivityLogOnCollaborationQuery = {
  ...
  activityLogOnCollaboration: Array<
    ...
    | {
        ...
        updates: { __typename?: 'Room'; id: string };
      }
  >;
};
...
export type HubTemplateCanvasValuesQueryVariables = Exact<{
  hubId: Scalars['UUID_NAMEID'];
  canvasId: Scalars['UUID'];
}>;

export type HubTemplateCanvasValuesQuery = {
  __typename?: 'Query';
  hub: {
    __typename?: 'Hub';
    id: string;
...
export type PlatformTemplateCanvasValuesQueryVariables = Exact<{
  innovationPackId: Scalars['UUID_NAMEID'];
  canvasId: Scalars['UUID'];
}>;

export type PlatformTemplateCanvasValuesQuery = {
  __typename?: 'Query';
  platform: {
    __typename?: 'Platform';
    id: string;
...
export type CreateDiscussionMutation = {
  ...
  createDiscussion: {
    ...
    category: DiscussionCategory;
    profile: { __typename?: 'Profile'; id: string; displayName: string; description?: string | undefined };
    comments: { __typename?: 'Room'; messagesCount: number };
    authorization?:
