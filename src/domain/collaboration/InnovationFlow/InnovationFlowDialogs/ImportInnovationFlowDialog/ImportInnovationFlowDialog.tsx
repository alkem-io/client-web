...
import InnovationFlowTemplateView from '../../../../platform/admin/templates/InnovationTemplates/InnovationFlowTemplateView';
  ...
  const innovationPacks = [
    {
      ...
      nameID: '',
      id: '',
      templates: templatesData?.space.templates?.innovationFlowTemplates ?? [],
    },
  ];
