...
const KnowledgeBasePage = ({ journeyTypeName, scrollToCallout = false }: PropsWithChildren<KnowledgeBasePageProps>) => {
  ...
  const {
    ...
    challengeNameId,
    opportunityNameId,
    calloutGroups: [CalloutDisplayLocation.CommonKnowledgeRight],
  });
        ...
        <PageContent>
          <PageContentColumn columns={4}>
            ...
            <PageContentBlock>
              ...
              />
              <LinksList
                items={groupedCallouts[CalloutDisplayLocation.CommonKnowledgeRight]?.map(callout => {
          ...
          <PageContentColumn columns={8}>
            <CalloutsGroupView
              callouts={groupedCallouts[CalloutDisplayLocation.CommonKnowledgeRight]}
              spaceId={spaceNameId!}
