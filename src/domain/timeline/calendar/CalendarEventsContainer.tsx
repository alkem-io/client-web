...
import {
  ...
  CalendarEvent,
  CalendarEventDetailsFragment, CalendarEventInfoFragment,
  Profile,
...
export const CalendarEventsContainer: FC<CalendarEventsContainerProps> = ({
  ...
  const collaboration = opportunityData?.lookup.opportunity?.collaboration ?? challengeData?.lookup.challenge?.collaboration ?? spaceData?.space.collaboration;
