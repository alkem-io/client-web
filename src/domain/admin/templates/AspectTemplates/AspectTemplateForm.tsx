...
import { CreateTemplateInfoInput } from '../../../../models/graphql-schema';
...
const AspectTemplateForm = ({ title, initialValues, onSubmit, submitButtonText }: AspectTemplateFormProps) => {
