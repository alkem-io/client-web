...
import useTransferInnovationPack from './useTransferInnovationPack';

const T_PREFIX = 'pages.admin.transferPack';

const TransferInnovationPackSection = () => {
  const { t } = useTranslation();
  const [confirmDialogOpen, setConfirmDialogOpen] = useState(false);
  const [targetAccountId, setTargetAccountId] = useState<string | undefined>();

  const { pack, currentAccountName, loading, transferLoading, error, handleResolve, handleTransfer } =
...
export default TransferInnovationPackSection;
