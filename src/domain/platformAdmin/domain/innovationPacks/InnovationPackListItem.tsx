...
interface InnovationPackListItemProps extends ListItemLinkProps {
  listedInStore: boolean;
  searchVisibility: SearchVisibility;
  accountOwner?: string;
}

const InnovationPackListItem = ({
  listedInStore,
  searchVisibility,
  accountOwner,
  ...props
}: InnovationPackListItemProps) => {
  return (
    <ListItemLink
      {...props}
      primary={
...
export default InnovationPackListItem;
