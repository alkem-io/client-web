...
const UserAdminNotificationsPage = () => {
  ...
  const buildSpaceSettings = (property: string, type: ChannelType, value: boolean) => ({
    ...
    collaborationPollVoteCastOnOwnPoll: createNotificationChannel(type, property, 'collaborationPollVoteCastOnOwnPoll', value, currentSettings.space?.collaborationPollVoteCastOnOwnPoll),
    collaborationPollVoteCastOnPollIVotedOn: createNotificationChannel(type, property, 'collaborationPollVoteCastOnPollIVotedOn', value, currentSettings.space?.collaborationPollVoteCastOnPollIVotedOn),
    collaborationPollModifiedOnPollIVotedOn: createNotificationChannel(type, property, 'collaborationPollModifiedOnPollIVotedOn', value, currentSettings.space?.collaborationPollModifiedOnPollIVotedOn),
    collaborationPollVoteAffectedByOptionChange: createNotificationChannel(type, property, 'collaborationPollVoteAffectedByOptionChange', value, currentSettings.space?.collaborationPollVoteAffectedByOptionChange),
  });
