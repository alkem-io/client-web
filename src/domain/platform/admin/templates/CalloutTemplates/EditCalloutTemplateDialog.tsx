...
import { useCalloutTemplateFramingDefaultContributionsQuery } from '../../../../../core/apollo/generated/apollo-hooks';
...
const EditCalloutTemplateDialog = ({ template, open, onClose, onSubmit }: EditCalloutTemplateDialogProps) => {
  ...
  const { data } = useCalloutTemplateFramingDefaultContributionsQuery({
    variables: {
