...
interface Props {
  ...
  onSubmit: (formData: SpaceCreateFormValuesType) => void;
  wireSubmit: (setter: () => void) => void;
  isEdit: boolean;
}

export interface SpaceCreateFormValuesType {
  name: string;
  nameID: string;
  host: string;
  tagline: string;
...
const SpaceCreateForm: FC<Props> = ({
  profile,
  name,
  nameID,
  hostID,
  ...
  const initialValues: SpaceCreateFormValuesType = {
    name: name ?? '',
    nameID: nameID ?? '',
