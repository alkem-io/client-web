...
import ChallengeExplorerSearchEnricherContainer
  from '../../../containers/challenge/ChallengeExplorerSearch/ChallengeExplorerSearchEnricherContainer';
...
import ChallengeExplorerSearchContainer
  from '../../../containers/challenge/ChallengeExplorerSearch/ChallengeExplorerSearchContainer';
        ...
        <GroupBy data={challenges} groupKey={groupKey}>
          {groups => {
            return groups.map(({ keyValue, values }) => (
              <Accordion title={keyValue} ariaKey={keyValue}>
                <CardContainer>
                  {values.map((value, i) => (
...
const getGroupKey = (groupBy: ChallengeExplorerGroupByType): keyof ChallengeExplorerSearchResultFragment | undefined => {
  switch (groupBy) {
    case 'hub': return 'ecoverseID';
